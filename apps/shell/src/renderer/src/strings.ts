...
export const strings = {
  zh: {
    ...
    navRecent: '最近',
    navStarred: '收藏',
    navCloud: 'Hermes Projects',
    cloudSubtitle: '在网页端用 Hermes AI 创建的项目。编辑在浏览器中继续——点击任意项目即可打开。',
    ...
    cloudSortOldest: '最早',
    cloudRefresh: '刷新',
    cloudLoginHint: '登录 Hermes 账号，查看你在网页端创建的项目。',
    cloudEmpty: '还没有网页端项目。',
    ...
    loginCopyUrl: '复制登录链接',
    loginCopied: '已复制',
    loginNetworkError: '无法连接 Hermes,请检查网络或代理设置',
    ...
    intgHeroTitle: '在 AI 助手里使用 HermesOffice',
    intgHeroDesc:
    ...
    intgStep1Update: 'HermesOffice 升级带来新版 skill 时，对应助手旁会出现「更新」按钮。',
    ...
    intgOtherFolderDesc: '选择它的 skills 目录，HermesOffice 把文件写进去。',
    ...
    intgExample3: '把 budget.xlsx 转成 PDF，并在 HermesOffice 里打开',
    intgStep2Note: '助手会自己调用 hermesoffice 命令行，你不需要输入任何命令。',
    intgCliPartTitle: 'CLI · 命令行 + skill',
    intgCliPartDesc:
      '适合能运行终端命令的助手（Claude Code、Codex、Cursor 等）。安装 skill 后，助手会自己调用 hermesoffice 命令行创建、转换、读取和编辑文件，你不需要输入任何命令。',
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP 是 AI 助手调用外部工具的通用协议。助手不能运行命令（如 Claude Desktop），或你想让它直接操作 HermesOffice 窗口时用这条路。下面两种接法任选一种。',
    intgMcpStdioTitle: '由助手启动（推荐）',
    intgMcpStdioDesc:
      '助手自己拉起 hermesoffice mcp，不需要在这里开任何开关，HermesOffice 也不用开着。功能与 CLI 完全相同。',
    intgMcpHttpTitle: '本地 HTTP 服务',
    intgMcpHttpDesc:
      '在 HermesOffice 内运行，助手通过网址连接，可以看着它在 Word 编辑器里逐步生成。需要 HermesOffice 保持打开；目前只支持 Word。',
    intgMcpHttpAdvanced: '高级：其他地址与日志',
    intgMcpTryNote: '助手会通过 MCP 调用 HermesOffice，你不需要输入任何命令。',
    ...
    intgCliTitle: '高级：命令行 hermesoffice',
    intgCliReady: 'hermesoffice {v} · 已可在终端直接使用（{path}）',
    intgCliNotOnPath:
      'hermesoffice {v} · 尚未加入终端 PATH。助手仍能通过 ~/.hermesoffice/launcher 找到它，skill 不受影响。若想自己在终端输入 hermesoffice，运行一次：',
    ...
    intgCopied: '已复制',
    intgCliEphemeral: '请先把 HermesOffice 拖到「应用程序」，再使用命令行。',
    intgCopyPath: '复制路径',
    intgCliNeedsUpdate: '此 skill 需要命令行 {v} 或更新版本，请更新 HermesOffice。',
    intgLoading: '正在检测…',
    ...
    setAiHermesHint: '使用 Hermes 账号登录，无需 API key。',
    ...
    setAiByokNote:
      '对话使用你自己的 key；生图与媒体解析按「生图与媒体」设置；网页搜索仍走 Hermes 登录或免费来源。',
    setAiSave: '保存',
    setAiSaved: '已保存',
    setAiTest: '测试连接',
    setAiTesting: '测试中…',
    ...
    setAiMediaHermesHint: '生图与图片/视频解析使用 Hermes 账号登录。',
    setAiImageModel: '生图模型',
    setAiAnalysisModel: '解析模型',
    setAiSearchHermesHint:
      '网页与图片搜索使用 Hermes 账号登录；未登录或关闭云工具时改用免费来源。',
    ...
    setAiGskTools: 'Hermes 云工具',
    setAiGskToolsDesc:
      '服务商选择 Hermes 时，网页搜索、生图与媒体解析经 Hermes 云端并消耗积分；关闭后搜索改用免费来源，Hermes 生图工具不可用。',
    setGithub: '开源项目',
    starOnGitHub: '去 GitHub 点 Star',
    starPromptTitle: '喜欢 HermesOffice 吗？',
    starPromptTitleN: '你已经用 HermesOffice 打开了 {n} 个文档',
    starPromptBody: 'HermesOffice 是免费开源软件。到 GitHub 给我们一个 Star，是对团队最好的支持。',
    starPromptGo: '去点 Star',
    starPromptDone: '已经点过了',
    starPromptLater: '以后再说',
    onbStarHint: '如果你喜欢 HermesOffice，欢迎到 GitHub 给我们一个 Star。',
    setEmail: '邮箱',
    setNotLoggedIn: '未登录',
    setViewUsage: '查看用量',
    setChange: '更改',
    ...
    onbTitle2: '这只是一个开始',
    onbBody2: 'HermesOffice 目前处于 alpha 阶段。欢迎加入 GitHub 群聊，分享反馈，一起塑造它的未来。',
    onbCredits: '活跃贡献者可获得 **1,000+ open-source contribution**',
    onbJoinGitHub: '加入 GitHub',
    onbSkip: '跳过',
    onbNext: '下一步',
    onbStart: '开始使用',
    ...
    onbNote3: 'AI 功能可能消耗 open-source contribution。',
    onbBack: '上一步',
  },
  en: {
    navRecent: 'Recent',
    ...
    navCloud: 'Hermes Projects',
    cloudSubtitle:
      'Projects created on the web with Hermes AI. Editing continues in your browser — click any project to open it.',
    ...
    cloudLoginHint: 'Sign in to your Hermes account to see projects you created on the web.',
    ...
    loginCopied: 'Copied',
    loginNetworkError: 'Cannot reach Hermes — check your network or proxy settings',
    ...
    intgHeroTitle: 'Use HermesOffice from your AI assistant',
    intgHeroDesc:
    ...
    intgStep1Update:
      'When a HermesOffice update ships a newer skill, an Update button appears next to that assistant.',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'Pick its skills folder and HermesOffice writes the file there.',
    ...
    intgExample3: 'Convert budget.xlsx to PDF and open it in HermesOffice',
    intgStep2Note:
      'The assistant runs the hermesoffice command line itself; you never have to type it.',
    intgCliPartTitle: 'CLI · command line + skill',
    intgCliPartDesc:
      'For assistants that can run terminal commands (Claude Code, Codex, Cursor and others). Once the skill is installed, the assistant calls the hermesoffice command line itself to create, convert, read and edit files; you never type a command.',
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP is the common protocol AI assistants use to call external tools. Use it when your assistant cannot run commands (Claude Desktop, for example) or when you want it to drive the HermesOffice window directly. Pick either of the two ways below.',
    intgMcpStdioTitle: 'Started by the assistant (recommended)',
    intgMcpStdioDesc:
      'The assistant launches hermesoffice mcp itself: nothing to switch on here, and HermesOffice does not need to be open. Same features as the CLI.',
    intgMcpHttpTitle: 'Local HTTP server',
    intgMcpHttpDesc:
      'Runs inside HermesOffice; the assistant connects to a URL and you can watch it build the document step by step in the Word editor. HermesOffice must stay open; Word documents only for now.',
    intgMcpHttpAdvanced: 'Advanced: other endpoints and log',
    intgMcpTryNote: 'The assistant calls HermesOffice through MCP; you never type a command.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCliTitle: 'Advanced: hermesoffice command line',
    intgCliReady: 'hermesoffice {v} · ready in your terminal ({path})',
    intgCliNotOnPath:
      "hermesoffice {v} · not on your terminal's PATH. Assistants still find it through ~/.hermesoffice/launcher, so the skill works. To type hermesoffice yourself, run this once:",
    ...
    intgCopied: 'Copied',
    intgCliEphemeral: 'Drag HermesOffice into Applications first, then use the command line.',
    intgCopyPath: 'Copy path',
    intgCliNeedsUpdate: 'This skill needs command line {v} or newer; update HermesOffice.',
    ...
    setAiHermesHint: 'Uses your Hermes sign-in; no API key needed.',
    ...
    setAiByokNote:
      'Chats use your own key. Image generation and media analysis follow the AI Media section; web search still uses the Hermes sign-in or free sources.',
    setAiSave: 'Save',
    setAiSaved: 'Saved',
    ...
    setAiMediaHermesHint: 'Image generation and image/video analysis use your Hermes sign-in.',
    setAiImageModel: 'Image model',
    setAiAnalysisModel: 'Analysis model',
    setAiSearchHermesHint:
      'Web and image search use your Hermes sign-in; signed out or with cloud tools off they fall back to free sources.',
    ...
    setAiGskTools: 'Hermes cloud tools',
    setAiGskToolsDesc:
      'Web search, image generation and media analysis run through Hermes and use credits while their provider is set to Hermes; when off, search uses free sources and the Hermes image tools are unavailable.',
    setGithub: 'Open Source',
    starOnGitHub: 'Star on GitHub',
    starPromptTitle: 'Enjoying HermesOffice?',
    starPromptTitleN: "You've opened {n} documents with HermesOffice",
    starPromptBody:
      'HermesOffice is free and open source. A star on GitHub is the best way to support the team.',
    starPromptGo: 'Star on GitHub',
    starPromptDone: 'Already starred',
    starPromptLater: 'Maybe later',
    onbStarHint: 'If you like HermesOffice, give us a star on GitHub.',
    setEmail: 'Email',
    ...
    onbBody2:
      'HermesOffice is still in alpha. Join the group chat on GitHub to share feedback and help shape what comes next.',
    onbCredits: 'Active contributors get **1,000+ open-source contribution**',
    onbJoinGitHub: 'Join GitHub',
    onbSkip: 'Skip',
    onbNext: 'Next',
    ...
    onbNote3: 'AI features may consume open-source contribution.',
    onbBack: 'Back',
  },
  ja: {
    // Sidebar navigation
    ...
    navCloud: 'Hermes Projects',
    cloudSubtitle:
      'Web で Hermes AI を使って作成したプロジェクト。編集はブラウザで続行します。クリックで開きます。',
    ...
    cloudRefresh: '更新',
    cloudLoginHint:
      'Hermes アカウントにサインインすると、Web で作成したプロジェクトを表示できます。',
    ...
    loginCopied: 'コピーしました',
    loginNetworkError:
      'Hermes に接続できません。ネットワークまたはプロキシ設定を確認してください',
    ...
    intgHeroTitle: 'AI アシスタントから HermesOffice を使う',
    intgHeroDesc:
    ...
    intgStep1Update:
      'HermesOffice の更新で新しいスキルが届くと、そのアシスタントの横に「更新」ボタンが表示されます。',
    ...
    intgOtherFolderDesc: 'その skills フォルダーを選ぶと、HermesOffice がファイルを書き込みます。',
    ...
    intgExample3: 'budget.xlsx を PDF に変換して HermesOffice で開いて',
    intgStep2Note:
      'hermesoffice コマンドラインはアシスタントが自分で実行します。あなたが入力する必要はありません。',
    intgCliPartTitle: 'CLI · コマンドライン + skill',
    intgCliPartDesc:
      'ターミナルコマンドを実行できるアシスタント（Claude Code、Codex、Cursor など）向け。skill をインストールすると、アシスタントが自分で hermesoffice コマンドラインを呼び出してファイルを作成・変換・読み取り・編集します。コマンドを入力する必要はありません。',
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP は AI アシスタントが外部ツールを呼び出すための共通プロトコルです。アシスタントがコマンドを実行できない場合（Claude Desktop など）や、HermesOffice のウィンドウを直接操作させたい場合に使います。下の 2 つの方法からどちらか 1 つを選んでください。',
    intgMcpStdioTitle: 'アシスタントが起動する（推奨）',
    intgMcpStdioDesc:
      'アシスタントが hermesoffice mcp を自分で起動します。ここで何かをオンにする必要はなく、HermesOffice を開いておく必要もありません。機能は CLI と同じです。',
    intgMcpHttpTitle: 'ローカル HTTP サーバー',
    intgMcpHttpDesc:
      'HermesOffice 内で動作し、アシスタントは URL で接続します。Word エディター上で文書が段階的に生成される様子を見られます。HermesOffice を開いたままにする必要があり、現時点では Word のみ対応です。',
    intgMcpHttpAdvanced: '詳細：その他のエンドポイントとログ',
    intgMcpTryNote:
      'アシスタントが MCP 経由で HermesOffice を呼び出します。コマンドを入力する必要はありません。',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCliTitle: '上級：コマンドライン hermesoffice',
    intgCliReady: 'hermesoffice {v} · ターミナルで使えます（{path}）',
    intgCliNotOnPath:
      'hermesoffice {v} · ターミナルの PATH にありません。アシスタントは ~/.hermesoffice/launcher 経由で見つけられるため、スキルは動作します。自分で hermesoffice を入力したい場合は一度だけ次を実行：',
    ...
    intgCopied: 'コピーしました',
    intgCliEphemeral:
      '先に HermesOffice を「アプリケーション」に移してから、コマンドラインを使ってください。',
    intgCopyPath: 'パスをコピー',
    intgCliNeedsUpdate:
      'このスキルにはコマンドライン {v} 以降が必要です。HermesOffice を更新してください。',
    intgLoading: '確認中…',
    ...
    setAiHermesHint: 'Hermes アカウントでサインインするため、API キーは不要です。',
    ...
    setAiByokNote:
      'チャットは自分のキーを使用します。画像生成とメディア解析は「AI メディア」の設定に従い、Web 検索は引き続き Hermes のサインインまたは無料ソースを使用します。',
    setAiSave: '保存',
    setAiSaved: '保存しました',
    setAiTest: '接続テスト',
    setAiTesting: 'テスト中…',
    ...
    setAiMediaHermesHint: '画像生成と画像/動画解析は Hermes のサインインを使用します。',
    setAiImageModel: '画像モデル',
    setAiAnalysisModel: '解析モデル',
    setAiSearchHermesHint:
      'Web 検索と画像検索は Hermes のサインインを使用します。サインアウト時やクラウドツールがオフのときは無料ソースにフォールバックします。',
    ...
    setAiGskTools: 'Hermes クラウドツール',
    setAiGskToolsDesc:
      'プロバイダーが Hermes のとき、Web 検索・画像生成・メディア解析は Hermes 経由でクレジットを消費します。オフにすると検索は無料ソースを使い、Hermes の画像ツールは利用できません。',
    setGithub: 'オープンソース',
    starOnGitHub: 'GitHub でスターを付ける',
    starPromptTitle: 'HermesOffice はいかがですか？',
    starPromptTitleN: 'HermesOffice で {n} 件のドキュメントを開きました',
    starPromptBody:
      'HermesOffice は無料のオープンソースソフトウェアです。GitHub のスターがチームへの何よりの応援になります。',
    starPromptGo: 'スターを付ける',
    starPromptDone: 'スター済み',
    starPromptLater: 'あとで',
    onbStarHint: 'HermesOffice が気に入ったら、GitHub でスターをお願いします。',
    setEmail: 'メール',
    ...
    onbBody2:
      'HermesOffice はまだアルファ版です。GitHub のグループチャットに参加して、フィードバックを共有し、今後の開発を一緒に形作りましょう。',
    onbCredits: 'アクティブな貢献者への特典 **1,000+ オープンソースへの貢献**',
    onbJoinGitHub: 'GitHub に参加',
    onbSkip: 'スキップ',
    onbNext: '次へ',
    onbStart: 'はじめる',
    ...
    onbNote3: 'AI 機能は オープンソースへの貢献を消費する場合があります。',
    onbBack: '戻る',
  },
  ko: {
    // Sidebar navigation
    ...
    navCloud: 'Hermes Projects',
    cloudSubtitle:
      'Hermes AI로 웹에서 만든 프로젝트입니다. 편집은 브라우저에서 계속됩니다. 프로젝트를 클릭하면 열립니다.',
    ...
    cloudRefresh: '새로고침',
    cloudLoginHint: 'Hermes 계정에 로그인하면 웹에서 만든 프로젝트를 볼 수 있습니다.',
    ...
    loginCopied: '복사됨',
    loginNetworkError: 'Hermes에 연결할 수 없습니다. 네트워크 또는 프록시 설정을 확인하세요',
    ...
    intgHeroTitle: 'AI 어시스턴트에서 HermesOffice 사용하기',
    intgHeroDesc:
    ...
    intgStep1Update:
      'HermesOffice 업데이트에 새 스킬이 포함되면 해당 어시스턴트 옆에 업데이트 버튼이 나타납니다.',
    ...
    intgOtherFolderDesc: '해당 skills 폴더를 선택하면 HermesOffice가 파일을 기록합니다.',
    ...
    intgExample3: 'budget.xlsx를 PDF로 변환해서 HermesOffice에서 열어 줘',
    intgStep2Note:
      'hermesoffice 명령줄은 어시스턴트가 직접 실행하므로 여러분이 입력할 필요가 없습니다.',
    intgCliPartTitle: 'CLI · 명령줄 + skill',
    intgCliPartDesc:
      '터미널 명령을 실행할 수 있는 어시스턴트(Claude Code, Codex, Cursor 등)용입니다. skill을 설치하면 어시스턴트가 스스로 hermesoffice 명령줄을 호출해 파일을 만들고 변환하고 읽고 편집합니다. 명령을 직접 입력할 필요가 없습니다.',
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP는 AI 어시스턴트가 외부 도구를 호출하는 공통 프로토콜입니다. 어시스턴트가 명령을 실행할 수 없거나(예: Claude Desktop) HermesOffice 창을 직접 조작하게 하려면 이 방식을 사용하세요. 아래 두 방법 중 하나를 선택하면 됩니다.',
    intgMcpStdioTitle: '어시스턴트가 실행(권장)',
    intgMcpStdioDesc:
      '어시스턴트가 hermesoffice mcp를 직접 실행합니다. 여기서 켤 것이 없고 HermesOffice가 열려 있을 필요도 없습니다. 기능은 CLI와 같습니다.',
    intgMcpHttpTitle: '로컬 HTTP 서버',
    intgMcpHttpDesc:
      'HermesOffice 안에서 실행되며 어시스턴트가 URL로 연결합니다. Word 편집기에서 문서가 단계별로 만들어지는 과정을 볼 수 있습니다. HermesOffice를 열어 두어야 하며 현재는 Word만 지원합니다.',
    intgMcpHttpAdvanced: '고급: 기타 주소와 로그',
    intgMcpTryNote:
      '어시스턴트가 MCP를 통해 HermesOffice를 호출합니다. 명령을 직접 입력할 필요가 없습니다.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCliTitle: '고급: 명령줄 hermesoffice',
    intgCliReady: 'hermesoffice {v} · 터미널에서 바로 사용 가능({path})',
    intgCliNotOnPath:
      'hermesoffice {v} · 터미널 PATH에 없습니다. 어시스턴트는 ~/.hermesoffice/launcher로 찾을 수 있어 스킬은 정상 작동합니다. 직접 hermesoffice를 입력하려면 한 번만 실행:',
    ...
    intgCopied: '복사됨',
    intgCliEphemeral: '먼저 HermesOffice를 응용 프로그램 폴더로 옮긴 뒤 명령줄을 사용하세요.',
    intgCopyPath: '경로 복사',
    intgCliNeedsUpdate: '이 스킬은 명령줄 {v} 이상이 필요합니다. HermesOffice를 업데이트하세요.',
    intgLoading: '확인 중…',
    ...
    setAiHermesHint: 'Hermes 로그인으로 사용하며 API 키가 필요 없습니다.',
    ...
    setAiByokNote:
      '채팅은 내 키를 사용합니다. 이미지 생성과 미디어 분석은 「AI 미디어」 설정을 따르며, 웹 검색은 여전히 Hermes 로그인 또는 무료 소스를 사용합니다.',
    setAiSave: '저장',
    setAiSaved: '저장됨',
    setAiTest: '연결 테스트',
    setAiTesting: '테스트 중…',
    ...
    setAiMediaHermesHint: '이미지 생성과 이미지/동영상 분석은 Hermes 로그인을 사용합니다.',
    setAiImageModel: '이미지 모델',
    setAiAnalysisModel: '분석 모델',
    setAiSearchHermesHint:
      '웹 검색과 이미지 검색은 Hermes 로그인을 사용합니다. 로그아웃 상태거나 클라우드 도구가 꺼져 있으면 무료 소스로 대체됩니다.',
    ...
    setAiGskTools: 'Hermes 클라우드 도구',
    setAiGskToolsDesc:
      '제공자가 Hermes일 때 웹 검색, 이미지 생성, 미디어 분석은 Hermes를 거쳐 크레딧을 사용합니다. 끄면 검색은 무료 소스를 사용하고 Hermes 이미지 도구는 사용할 수 없습니다.',
    setGithub: '오픈 소스',
    starOnGitHub: 'GitHub에서 스타 누르기',
    starPromptTitle: 'HermesOffice가 마음에 드시나요?',
    starPromptTitleN: 'HermesOffice로 문서를 {n}개 열어보셨네요',
    starPromptBody:
      'HermesOffice는 무료 오픈 소스 소프트웨어입니다. GitHub 스타 하나가 팀에게 가장 큰 응원이 됩니다.',
    starPromptGo: '스타 누르기',
    starPromptDone: '이미 눌렀어요',
    starPromptLater: '나중에',
    onbStarHint: 'HermesOffice가 마음에 들면 GitHub에서 스타를 눌러 주세요.',
    setEmail: '이메일',
    ...
    onbBody2:
      'HermesOffice는 아직 알파 단계입니다. GitHub 그룹 채팅에 참여해 피드백을 공유하고 앞으로의 방향을 함께 만들어 가세요.',
    onbCredits: '활발한 기여자를 위한 혜택 **1,000+ Hermes 크레딧**',
    onbJoinGitHub: 'GitHub 참여하기',
    onbSkip: '건너뛰기',
    onbNext: '다음',
    onbStart: '시작하기',
  ...
  fr: {
    ...
    navCloud: 'Hermes Projects',
    cloudSubtitle:
      "Projets créés sur le web avec Hermes AI. L'édition continue dans votre navigateur — cliquez sur un projet pour l'ouvrir.",
    ...
    cloudLoginHint:
      'Connectez-vous à votre compte Hermes pour voir les projets créés sur le web.',
    ...
    loginCopied: 'Copié',
    loginNetworkError:
      'Impossible de joindre Hermes — vérifiez votre réseau ou vos paramètres de proxy',
    ...
    intgHeroTitle: 'Utiliser HermesOffice depuis votre assistant IA',
    intgHeroDesc:
    ...
    intgStep1Update:
      'Quand une mise à jour de HermesOffice apporte un skill plus récent, un bouton Mettre à jour apparaît à côté de cet assistant.',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'Choisissez son dossier skills et HermesOffice y écrit le fichier.',
    ...
    intgExample3: 'Convertis budget.xlsx en PDF et ouvre-le dans HermesOffice',
    intgStep2Note:
      "L'assistant lance lui-même la ligne de commande hermesoffice ; vous n'avez jamais à la saisir.",
    intgCliPartTitle: 'CLI · ligne de commande + skill',
    intgCliPartDesc:
      'Pour les assistants capables de lancer des commandes dans le terminal (Claude Code, Codex, Cursor, etc.). Une fois le skill installé, l’assistant appelle lui-même la ligne de commande hermesoffice pour créer, convertir, lire et modifier les fichiers ; vous ne tapez jamais de commande.',
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP est le protocole commun que les assistants IA utilisent pour appeler des outils externes. Utilisez-le si votre assistant ne peut pas lancer de commandes (Claude Desktop, par exemple) ou si vous voulez qu’il pilote directement la fenêtre HermesOffice. Choisissez l’une des deux méthodes ci-dessous.',
    intgMcpStdioTitle: 'Lancé par l’assistant (recommandé)',
    intgMcpStdioDesc:
      'L’assistant lance lui-même hermesoffice mcp : rien à activer ici, et HermesOffice n’a pas besoin d’être ouvert. Mêmes fonctions que la CLI.',
    intgMcpHttpTitle: 'Serveur HTTP local',
    intgMcpHttpDesc:
      'Tourne dans HermesOffice ; l’assistant se connecte à une URL et vous voyez le document se construire pas à pas dans l’éditeur Word. HermesOffice doit rester ouvert ; documents Word uniquement pour l’instant.',
    intgMcpHttpAdvanced: 'Avancé : autres adresses et journal',
    intgMcpTryNote: 'L’assistant appelle HermesOffice via MCP ; vous ne tapez jamais de commande.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCliTitle: 'Avancé : ligne de commande hermesoffice',
    intgCliReady: 'hermesoffice {v} · prêt dans votre terminal ({path})',
    intgCliNotOnPath:
      'hermesoffice {v} · absent du PATH de votre terminal. Les assistants le trouvent quand même via ~/.hermesoffice/launcher, le skill fonctionne donc. Pour taper hermesoffice vous-même, exécutez ceci une fois :',
    ...
    intgCopied: 'Copié',
    intgCliEphemeral:
      "Glissez d'abord HermesOffice dans Applications, puis utilisez la ligne de commande.",
    intgCopyPath: 'Copier le chemin',
    intgCliNeedsUpdate:
      'Ce skill requiert la ligne de commande {v} ou plus récente ; mettez HermesOffice à jour.',
    ...
    setAiHermesHint: 'Utilise votre connexion Hermes ; aucune clé API requise.',
    ...
    setAiByokNote:
      "Les conversations utilisent votre propre clé. La génération d'images et l'analyse de médias suivent la section « Médias IA » ; la recherche web utilise toujours la connexion Hermes ou des sources gratuites.",
    ...
    setAiMediaHermesHint:
      "La génération d'images et l'analyse d'images/vidéos utilisent votre connexion Hermes.",
    setAiImageModel: "Modèle d'image",
    setAiAnalysisModel: "Modèle d'analyse",
    setAiSearchHermesHint:
      "La recherche web et d'images utilise votre connexion Hermes ; déconnecté ou avec les outils cloud désactivés, elle se rabat sur des sources gratuites.",
    ...
    setAiGskTools: 'Outils cloud Hermes',
    setAiGskToolsDesc:
      "Lorsque leur fournisseur est Hermes, la recherche web, la génération d'images et l'analyse de médias passent par Hermes et consomment des crédits ; désactivé, la recherche utilise des sources gratuites et les outils d'image Hermes sont indisponibles.",
    setGithub: 'Open source',
    starOnGitHub: 'Mettre une étoile sur GitHub',
    starPromptTitle: 'HermesOffice vous plaît ?',
    starPromptTitleN: 'Vous avez ouvert {n} documents avec HermesOffice',
    starPromptBody:
      'HermesOffice est gratuit et open source. Une étoile sur GitHub est le meilleur moyen de soutenir l’équipe.',
    starPromptGo: 'Mettre une étoile',
    starPromptDone: 'Déjà fait',
    starPromptLater: 'Plus tard',
    onbStarHint: 'Si HermesOffice vous plaît, mettez-nous une étoile sur GitHub.',
    setEmail: 'E-mail',
    ...
    onbBody2:
      'HermesOffice est encore en alpha. Rejoignez la discussion de groupe sur GitHub pour partager vos retours et façonner la suite.',
    onbCredits: 'Les contributeurs actifs reçoivent **1 000+ crédits Hermes**',
    onbJoinGitHub: 'Rejoindre GitHub',
    onbSkip: 'Passer',
    onbNext: 'Suivant',
    onbStart: 'Commencer',
  ...
  de: {
    ...
    navCloud: 'Hermes Projects',
    cloudSubtitle:
      'Mit Hermes AI im Web erstellte Projekte. Die Bearbeitung läuft im Browser weiter – klicken Sie auf ein Projekt, um es zu öffnen.',
    ...
    cloudLoginHint:
      'Melden Sie sich bei Ihrem Hermes-Konto an, um Ihre im Web erstellten Projekte zu sehen.',
    ...
    loginCopied: 'Kopiert',
    loginNetworkError:
      'Hermes ist nicht erreichbar — prüfen Sie Netzwerk- oder Proxy-Einstellungen',
    ...
    intgHeroTitle: 'HermesOffice aus Ihrem KI-Assistenten nutzen',
    intgHeroDesc:
    ...
    intgStep1Update:
      'Bringt ein HermesOffice-Update einen neueren Skill mit, erscheint neben diesem Assistenten ein Aktualisieren-Button.',
    intgSkillVersion: 'Skill {v}',
    ...
    intgOtherFolderDesc:
      'Wählen Sie seinen Skills-Ordner, und HermesOffice schreibt die Datei dorthin.',
    ...
    intgExample3: 'Wandle budget.xlsx in PDF um und öffne es in HermesOffice',
    intgStep2Note:
      'Der Assistent ruft die hermesoffice-Befehlszeile selbst auf; Sie müssen sie nie eintippen.',
    intgCliPartTitle: 'CLI · Kommandozeile + Skill',
    intgCliPartDesc:
      'Für Assistenten, die Terminalbefehle ausführen können (Claude Code, Codex, Cursor u. a.). Nach der Installation des Skills ruft der Assistent die hermesoffice-Kommandozeile selbst auf, um Dateien zu erstellen, zu konvertieren, zu lesen und zu bearbeiten; Sie tippen nie einen Befehl.',
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP ist das gemeinsame Protokoll, über das KI-Assistenten externe Werkzeuge aufrufen. Nutzen Sie es, wenn der Assistent keine Befehle ausführen kann (z. B. Claude Desktop) oder wenn er das HermesOffice-Fenster direkt steuern soll. Wählen Sie einen der beiden Wege unten.',
    intgMcpStdioTitle: 'Vom Assistenten gestartet (empfohlen)',
    intgMcpStdioDesc:
      'Der Assistent startet hermesoffice mcp selbst: hier ist nichts einzuschalten, und HermesOffice muss nicht geöffnet sein. Gleicher Funktionsumfang wie die CLI.',
    intgMcpHttpTitle: 'Lokaler HTTP-Server',
    intgMcpHttpDesc:
      'Läuft in HermesOffice; der Assistent verbindet sich über eine URL, und Sie sehen im Word-Editor zu, wie das Dokument Schritt für Schritt entsteht. HermesOffice muss geöffnet bleiben; derzeit nur Word-Dokumente.',
    intgMcpHttpAdvanced: 'Erweitert: weitere Adressen und Protokoll',
    intgMcpTryNote: 'Der Assistent ruft HermesOffice über MCP auf; Sie tippen nie einen Befehl.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCliTitle: 'Erweitert: Befehlszeile hermesoffice',
    intgCliReady: 'hermesoffice {v} · im Terminal verfügbar ({path})',
    intgCliNotOnPath:
      'hermesoffice {v} · nicht im PATH Ihres Terminals. Assistenten finden es trotzdem über ~/.hermesoffice/launcher, der Skill funktioniert also. Um hermesoffice selbst einzugeben, führen Sie dies einmal aus:',
    ...
    intgCopied: 'Kopiert',
    intgCliEphemeral:
      'Ziehen Sie HermesOffice zuerst in „Programme“, dann nutzen Sie die Befehlszeile.',
    intgCopyPath: 'Pfad kopieren',
    intgCliNeedsUpdate:
      'Dieser Skill braucht Befehlszeile {v} oder neuer; aktualisieren Sie HermesOffice.',
    intgLoading: 'Prüfe …',
    ...
    setAiHermesHint: 'Nutzt Ihre Hermes-Anmeldung; kein API-Schlüssel nötig.',
    ...
    setAiByokNote:
      'Chats nutzen deinen eigenen Schlüssel. Bildgenerierung und Medienanalyse folgen dem Abschnitt „KI-Medien“; die Websuche nutzt weiterhin die Hermes-Anmeldung oder kostenlose Quellen.',
    setAiSave: 'Speichern',
    ...
    setAiMediaHermesHint:
      'Bildgenerierung und Bild-/Videoanalyse nutzen deine Hermes-Anmeldung.',
    setAiImageModel: 'Bildmodell',
    setAiAnalysisModel: 'Analysemodell',
    setAiSearchHermesHint:
      'Web- und Bildsuche nutzen deine Hermes-Anmeldung; abgemeldet oder mit ausgeschalteten Cloud-Tools greifen sie auf kostenlose Quellen zurück.',
    ...
    setAiGskTools: 'Hermes-Cloud-Tools',
    setAiGskToolsDesc:
      'Steht ihr Anbieter auf Hermes, laufen Websuche, Bildgenerierung und Medienanalyse über Hermes und verbrauchen Credits; ausgeschaltet nutzt die Suche kostenlose Quellen und die Hermes-Bildwerkzeuge sind nicht verfügbar.',
    setGithub: 'Open Source',
    starOnGitHub: 'Auf GitHub Stern geben',
    starPromptTitle: 'Gefällt Ihnen HermesOffice?',
    starPromptTitleN: 'Sie haben {n} Dokumente mit HermesOffice geöffnet',
    starPromptBody:
      'HermesOffice ist kostenlos und Open Source. Ein Stern auf GitHub ist die beste Unterstützung für das Team.',
    starPromptGo: 'Stern geben',
    starPromptDone: 'Schon erledigt',
    starPromptLater: 'Später',
    onbStarHint: 'Wenn Ihnen HermesOffice gefällt, geben Sie uns einen Stern auf GitHub.',
    setEmail: 'E-Mail',
    ...
    onbBody2:
      'HermesOffice ist noch in der Alpha-Phase. Treten Sie dem Gruppenchat auf GitHub bei, um Feedback zu teilen und die Zukunft mitzugestalten.',
    onbCredits: 'Aktive Mitwirkende erhalten **1.000+ Hermes-Guthaben**',
    onbJoinGitHub: 'GitHub beitreten',
  ...
  es: {
    ...
    navCloud: 'Hermes Projects',
    cloudSubtitle:
      'Proyectos creados en la web con Hermes AI. La edición continúa en tu navegador: haz clic en un proyecto para abrirlo.',
    ...
    cloudLoginHint:
      'Inicia sesión en tu cuenta de Hermes para ver los proyectos creados en la web.',
    ...
    loginCopied: 'Copiado',
    loginNetworkError:
      'No se puede conectar con Hermes — compruebe su red o la configuración del proxy',
    ...
    intgHeroTitle: 'Usa HermesOffice desde tu asistente de IA',
    intgHeroDesc:
    ...
    intgStep1Update:
      'Cuando una actualización de HermesOffice traiga un skill más nuevo, aparecerá un botón Actualizar junto a ese asistente.',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'Elige su carpeta de skills y HermesOffice escribe el archivo ahí.',
    ...
    intgExample3: 'Convierte budget.xlsx a PDF y ábrelo en HermesOffice',
    intgStep2Note:
      'El asistente ejecuta la línea de comandos hermesoffice por sí mismo; nunca tienes que escribirla.',
    intgCliPartTitle: 'CLI · línea de comandos + skill',
    intgCliPartDesc:
      'Para asistentes que pueden ejecutar comandos de terminal (Claude Code, Codex, Cursor y otros). Con el skill instalado, el asistente llama por sí mismo a la línea de comandos hermesoffice para crear, convertir, leer y editar archivos; nunca escribes un comando.',
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP es el protocolo común con el que los asistentes de IA llaman a herramientas externas. Úsalo cuando tu asistente no pueda ejecutar comandos (Claude Desktop, por ejemplo) o cuando quieras que controle directamente la ventana de HermesOffice. Elige una de las dos formas de abajo.',
    intgMcpStdioTitle: 'Iniciado por el asistente (recomendado)',
    intgMcpStdioDesc:
      'El asistente lanza hermesoffice mcp por sí mismo: nada que activar aquí, y HermesOffice no necesita estar abierto. Mismas funciones que la CLI.',
    intgMcpHttpTitle: 'Servidor HTTP local',
    intgMcpHttpDesc:
      'Se ejecuta dentro de HermesOffice; el asistente se conecta a una URL y puedes ver cómo construye el documento paso a paso en el editor de Word. HermesOffice debe permanecer abierto; por ahora solo documentos Word.',
    intgMcpHttpAdvanced: 'Avanzado: otras direcciones y registro',
    intgMcpTryNote: 'El asistente llama a HermesOffice a través de MCP; nunca escribes un comando.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCliTitle: 'Avanzado: línea de comandos hermesoffice',
    intgCliReady: 'hermesoffice {v} · listo en tu terminal ({path})',
    intgCliNotOnPath:
      'hermesoffice {v} · no está en el PATH de tu terminal. Los asistentes lo encuentran igualmente mediante ~/.hermesoffice/launcher, así que el skill funciona. Para escribir hermesoffice tú mismo, ejecuta esto una vez:',
    ...
    intgCopied: 'Copiado',
    intgCliEphemeral: 'Arrastra primero HermesOffice a Aplicaciones y luego usa la línea de comandos.',
    intgCopyPath: 'Copiar ruta',
    intgCliNeedsUpdate:
      'Este skill necesita la línea de comandos {v} o superior; actualiza HermesOffice.',
    ...
    setAiHermesHint: 'Usa tu inicio de sesión de Hermes; no se necesita clave de API.',
    ...
    setAiByokNote:
      'Los chats usan tu propia clave. La generación de imágenes y el análisis de medios siguen la sección «Medios de IA»; la búsqueda web sigue usando el inicio de sesión de Hermes o fuentes gratuitas.',
    setAiSave: 'Guardar',
    setAiSaved: 'Guardado',
    ...
    setAiMediaHermesHint:
      'La generación de imágenes y el análisis de imágenes/vídeos usan tu inicio de sesión de Hermes.',
    setAiImageModel: 'Modelo de imagen',
    setAiAnalysisModel: 'Modelo de análisis',
    setAiSearchHermesHint:
      'La búsqueda web y de imágenes usa tu inicio de sesión de Hermes; sin sesión o con las herramientas en la nube desactivadas recurre a fuentes gratuitas.',
    ...
    setAiGskTools: 'Herramientas en la nube de Hermes',
    setAiGskToolsDesc:
      'Cuando su proveedor es Hermes, la búsqueda web, la generación de imágenes y el análisis de medios pasan por Hermes y consumen créditos; desactivado, la búsqueda usa fuentes gratuitas y las herramientas de imagen de Hermes no están disponibles.',
    setGithub: 'Código abierto',
    starOnGitHub: 'Dar una estrella en GitHub',
    starPromptTitle: '¿Te gusta HermesOffice?',
    starPromptTitleN: 'Has abierto {n} documentos con HermesOffice',
    starPromptBody:
      'HermesOffice es gratuito y de código abierto. Una estrella en GitHub es la mejor forma de apoyar al equipo.',
    starPromptGo: 'Dar una estrella',
    starPromptDone: 'Ya la di',
    starPromptLater: 'Más tarde',
    onbStarHint: 'Si te gusta HermesOffice, danos una estrella en GitHub.',
    ...
    onbBody2:
      'HermesOffice aún está en alfa. Únete al chat grupal en GitHub para compartir comentarios y ayudar a dar forma a lo que viene.',
    onbCredits: 'Los colaboradores activos reciben **1.000+ créditos de Hermes**',
    onbJoinGitHub: 'Unirse a GitHub',
    onbSkip: 'Omitir',
    onbNext: 'Siguiente',
    onbStart: 'Empezar',
  ...
  th: {
    ...
    navCloud: 'Hermes Projects',
    cloudSubtitle:
      'โปรเจกต์ที่สร้างบนเว็บด้วย Hermes AI แก้ไขต่อได้ในเบราว์เซอร์ — คลิกโปรเจกต์เพื่อเปิด',
    ...
    cloudRefresh: 'รีเฟรช',
    cloudLoginHint: 'ลงชื่อเข้าใช้บัญชี Hermes เพื่อดูโปรเจกต์ที่คุณสร้างบนเว็บ',
    ...
    loginNetworkError: 'ไม่สามารถเชื่อมต่อ Hermes ได้ โปรดตรวจสอบเครือข่ายหรือการตั้งค่าพร็อกซี',
    ...
    intgHeroTitle: 'ใช้ HermesOffice จากผู้ช่วย AI ของคุณ',
    intgHeroDesc:
    ...
    intgStep1Update:
      'เมื่อการอัปเดต HermesOffice มาพร้อมสกิลเวอร์ชันใหม่ ปุ่มอัปเดตจะปรากฏข้างผู้ช่วยนั้น',
    ...
    intgOtherFolderDesc: 'เลือกโฟลเดอร์ skills ของผู้ช่วย แล้ว HermesOffice จะเขียนไฟล์ลงไป',
    ...
    intgExample3: 'แปลง budget.xlsx เป็น PDF แล้วเปิดใน HermesOffice',
    intgStep2Note: 'ผู้ช่วยจะเรียกใช้บรรทัดคำสั่ง hermesoffice เอง คุณไม่ต้องพิมพ์คำสั่งใด ๆ',
    intgCliPartTitle: 'CLI · บรรทัดคำสั่ง + skill',
    intgCliPartDesc:
      'สำหรับผู้ช่วยที่รันคำสั่งเทอร์มินัลได้ (Claude Code, Codex, Cursor และอื่น ๆ) เมื่อติดตั้ง skill แล้ว ผู้ช่วยจะเรียกบรรทัดคำสั่ง hermesoffice เองเพื่อสร้าง แปลง อ่าน และแก้ไขไฟล์ คุณไม่ต้องพิมพ์คำสั่งใด ๆ',
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP คือโปรโตคอลกลางที่ผู้ช่วย AI ใช้เรียกเครื่องมือภายนอก ใช้เมื่อผู้ช่วยรันคำสั่งไม่ได้ (เช่น Claude Desktop) หรือเมื่อต้องการให้มันควบคุมหน้าต่าง HermesOffice โดยตรง เลือกวิธีใดวิธีหนึ่งจากสองวิธีด้านล่าง',
    intgMcpStdioTitle: 'ให้ผู้ช่วยเป็นผู้เริ่ม (แนะนำ)',
    intgMcpStdioDesc:
      'ผู้ช่วยจะเรียก hermesoffice mcp ขึ้นมาเอง ไม่ต้องเปิดสวิตช์ใดที่นี่ และไม่ต้องเปิด HermesOffice ไว้ ความสามารถเหมือน CLI ทุกประการ',
    intgMcpHttpTitle: 'เซิร์ฟเวอร์ HTTP ในเครื่อง',
    intgMcpHttpDesc:
      'ทำงานอยู่ใน HermesOffice ผู้ช่วยเชื่อมต่อผ่าน URL และคุณจะเห็นเอกสารค่อย ๆ ถูกสร้างขึ้นในตัวแก้ไข Word ต้องเปิด HermesOffice ไว้ตลอด ปัจจุบันรองรับเฉพาะ Word',
    intgMcpHttpAdvanced: 'ขั้นสูง: ที่อยู่อื่นและบันทึก',
    intgMcpTryNote: 'ผู้ช่วยจะเรียก HermesOffice ผ่าน MCP คุณไม่ต้องพิมพ์คำสั่งใด ๆ',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCliTitle: 'ขั้นสูง: บรรทัดคำสั่ง hermesoffice',
    intgCliReady: 'hermesoffice {v} · พร้อมใช้ในเทอร์มินัล ({path})',
    intgCliNotOnPath:
      'hermesoffice {v} · ยังไม่อยู่ใน PATH ของเทอร์มินัล ผู้ช่วยยังหาเจอผ่าน ~/.hermesoffice/launcher สกิลจึงใช้งานได้ตามปกติ หากต้องการพิมพ์ hermesoffice เอง ให้รันคำสั่งนี้ครั้งเดียว:',
    ...
    intgCliEphemeral: 'กรุณาลาก HermesOffice ไปที่ Applications ก่อน แล้วจึงใช้บรรทัดคำสั่ง',
    intgCopyPath: 'คัดลอกพาธ',
    intgCliNeedsUpdate: 'สกิลนี้ต้องใช้บรรทัดคำสั่ง {v} หรือใหม่กว่า โปรดอัปเดต HermesOffice',
    ...
    setAiHermesHint: 'ใช้การลงชื่อเข้าใช้ Hermes ไม่ต้องใช้คีย์ API',
    ...
    setAiByokNote:
      'การแชทใช้คีย์ของคุณเอง การสร้างภาพและการวิเคราะห์สื่อเป็นไปตามส่วน "สื่อ AI" ส่วนการค้นหาเว็บยังใช้การลงชื่อเข้าใช้ Hermes หรือแหล่งข้อมูลฟรี',
    setAiSave: 'บันทึก',
    ...
    setAiMediaHermesHint:
      'การสร้างภาพและการวิเคราะห์ภาพ/วิดีโอใช้การลงชื่อเข้าใช้ Hermes ของคุณ',
    setAiImageModel: 'โมเดลสร้างภาพ',
    setAiAnalysisModel: 'โมเดลวิเคราะห์',
    setAiSearchHermesHint:
      'การค้นหาเว็บและภาพใช้การลงชื่อเข้าใช้ Hermes หากไม่ได้ลงชื่อเข้าใช้หรือปิดเครื่องมือคลาวด์ จะใช้แหล่งข้อมูลฟรีแทน',
    ...
    setAiGskTools: 'เครื่องมือคลาวด์ Hermes',
    setAiGskToolsDesc:
      'เมื่อผู้ให้บริการตั้งเป็น Hermes การค้นหาเว็บ การสร้างภาพ และการวิเคราะห์สื่อจะผ่าน Hermes และใช้เครดิต เมื่อปิด การค้นหาจะใช้แหล่งข้อมูลฟรีและเครื่องมือภาพของ Hermes จะใช้ไม่ได้',
    setGithub: 'โอเพนซอร์ส',
    starOnGitHub: 'กดดาวบน GitHub',
    starPromptTitle: 'ชอบ HermesOffice ไหม?',
    starPromptTitleN: 'คุณเปิดเอกสารด้วย HermesOffice ไปแล้ว {n} ไฟล์',
    starPromptBody:
      'HermesOffice ฟรีและเป็นโอเพนซอร์ส การกดดาวบน GitHub คือกำลังใจที่ดีที่สุดสำหรับทีม',
    starPromptGo: 'กดดาวเลย',
    starPromptDone: 'กดแล้ว',
    starPromptLater: 'ไว้ทีหลัง',
    onbStarHint: 'ถ้าชอบ HermesOffice ฝากกดดาวให้เราบน GitHub ด้วยนะ',
    setEmail: 'อีเมล',
    ...
    onbBody2:
      'HermesOffice ยังอยู่ในช่วงอัลฟ่า เข้าร่วมแชทกลุ่มบน GitHub เพื่อแบ่งปันความคิดเห็นและร่วมกำหนดทิศทางต่อไป',
    onbCredits: 'ผู้มีส่วนร่วมอย่างต่อเนื่องจะได้รับ **เครดิต Hermes กว่า 1,000**',
    onbJoinGitHub: 'เข้าร่วม GitHub',
    onbSkip: 'ข้าม',
    onbNext: 'ถัดไป',
  ...
  id: {
    ...
    navCloud: 'Hermes Projects',
    cloudSubtitle:
      'Proyek yang dibuat di web dengan Hermes AI. Pengeditan berlanjut di browser — klik proyek untuk membukanya.',
    ...
    cloudLoginHint: 'Masuk ke akun Hermes untuk melihat proyek yang Anda buat di web.',
    ...
    loginCopied: 'Disalin',
    loginNetworkError:
      'Tidak dapat terhubung ke Hermes — periksa jaringan atau pengaturan proxy Anda',
    ...
    intgHeroTitle: 'Gunakan HermesOffice dari asisten AI Anda',
    intgHeroDesc:
    ...
    intgStep1Update:
      'Saat pembaruan HermesOffice membawa skill yang lebih baru, tombol Perbarui muncul di samping asisten itu.',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'Pilih folder skills-nya dan HermesOffice menulis file di sana.',
    ...
    intgExample3: 'Konversi budget.xlsx ke PDF dan buka di HermesOffice',
    intgStep2Note:
      'Asisten menjalankan baris perintah hermesoffice sendiri; Anda tidak perlu mengetiknya.',
    intgCliPartTitle: 'CLI · baris perintah + skill',
    intgCliPartDesc:
      'Untuk asisten yang bisa menjalankan perintah terminal (Claude Code, Codex, Cursor, dan lainnya). Setelah skill terpasang, asisten memanggil baris perintah hermesoffice sendiri untuk membuat, mengonversi, membaca, dan mengedit file; Anda tidak pernah mengetik perintah.',
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP adalah protokol umum yang dipakai asisten AI untuk memanggil alat eksternal. Gunakan saat asisten Anda tidak bisa menjalankan perintah (misalnya Claude Desktop) atau saat Anda ingin ia mengendalikan jendela HermesOffice secara langsung. Pilih salah satu dari dua cara di bawah.',
    intgMcpStdioTitle: 'Dijalankan oleh asisten (disarankan)',
    intgMcpStdioDesc:
      'Asisten menjalankan hermesoffice mcp sendiri: tidak ada yang perlu dinyalakan di sini, dan HermesOffice tidak perlu terbuka. Fitur sama dengan CLI.',
    intgMcpHttpTitle: 'Server HTTP lokal',
    intgMcpHttpDesc:
      'Berjalan di dalam HermesOffice; asisten terhubung lewat URL dan Anda bisa melihat dokumen dibangun langkah demi langkah di editor Word. HermesOffice harus tetap terbuka; untuk saat ini hanya dokumen Word.',
    intgMcpHttpAdvanced: 'Lanjutan: alamat lain dan log',
    intgMcpTryNote: 'Asisten memanggil HermesOffice melalui MCP; Anda tidak pernah mengetik perintah.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCliTitle: 'Lanjutan: baris perintah hermesoffice',
    intgCliReady: 'hermesoffice {v} · siap di terminal Anda ({path})',
    intgCliNotOnPath:
      'hermesoffice {v} · belum ada di PATH terminal Anda. Asisten tetap menemukannya lewat ~/.hermesoffice/launcher, jadi skill tetap berfungsi. Untuk mengetik hermesoffice sendiri, jalankan ini sekali:',
    ...
    intgCopied: 'Disalin',
    intgCliEphemeral: 'Seret HermesOffice ke Applications dulu, lalu gunakan baris perintah.',
    intgCopyPath: 'Salin path',
    intgCliNeedsUpdate:
      'Skill ini memerlukan baris perintah {v} atau lebih baru; perbarui HermesOffice.',
    ...
    setAiHermesHint: 'Menggunakan login Hermes; tanpa kunci API.',
    ...
    setAiByokNote:
      'Chat memakai kunci Anda sendiri. Pembuatan gambar dan analisis media mengikuti bagian "Media AI"; pencarian web tetap memakai login Hermes atau sumber gratis.',
    setAiSave: 'Simpan',
    ...
    setAiMediaHermesHint:
      'Pembuatan gambar dan analisis gambar/video menggunakan login Hermes Anda.',
    setAiImageModel: 'Model gambar',
    setAiAnalysisModel: 'Model analisis',
    setAiSearchHermesHint:
      'Pencarian web dan gambar memakai login Hermes Anda; saat keluar atau alat cloud dimatikan, keduanya memakai sumber gratis.',
    ...
    setAiGskTools: 'Alat cloud Hermes',
    setAiGskToolsDesc:
      'Saat penyedianya disetel ke Hermes, pencarian web, pembuatan gambar, dan analisis media berjalan lewat Hermes dan memakai kredit; jika dimatikan, pencarian memakai sumber gratis dan alat gambar Hermes tidak tersedia.',
    setGithub: 'Sumber Terbuka',
    starOnGitHub: 'Beri Bintang di GitHub',
    starPromptTitle: 'Suka HermesOffice?',
    starPromptTitleN: 'Anda telah membuka {n} dokumen dengan HermesOffice',
    starPromptBody:
      'HermesOffice gratis dan open source. Bintang di GitHub adalah dukungan terbaik untuk tim kami.',
    starPromptGo: 'Beri Bintang',
    starPromptDone: 'Sudah',
    starPromptLater: 'Nanti saja',
    onbStarHint: 'Jika Anda menyukai HermesOffice, beri kami bintang di GitHub.',
    setEmail: 'Email',
    ...
    onbBody2:
      'HermesOffice masih dalam tahap alpha. Gabung obrolan grup di GitHub untuk berbagi masukan dan ikut menentukan arah ke depan.',
    onbCredits: 'Kontributor aktif mendapat **1.000+ kredit Hermes**',
    onbJoinGitHub: 'Gabung GitHub',
    onbSkip: 'Lewati',
    onbNext: 'Berikutnya',
    onbStart: 'Mulai',
  ...
  ru: {
    ...
    navCloud: 'Hermes Projects',
    cloudSubtitle:
      'Проекты, созданные в вебе с Hermes AI. Редактирование продолжается в браузере — нажмите на проект, чтобы открыть его.',
    ...
    cloudLoginHint: 'Войдите в аккаунт Hermes, чтобы увидеть проекты, созданные в вебе.',
    ...
    loginNetworkError: 'Не удаётся подключиться к Hermes — проверьте сеть или настройки прокси',
    ...
    intgHeroTitle: 'Используйте HermesOffice из своего ИИ-ассистента',
    intgHeroDesc:
    ...
    intgStep1Update:
      'Когда обновление HermesOffice принесёт более новый скилл, рядом с этим ассистентом появится кнопка «Обновить».',
    ...
    intgOtherFolderDesc: 'Выберите его папку skills, и HermesOffice запишет файл туда.',
    ...
    intgExample3: 'Конвертируй budget.xlsx в PDF и открой в HermesOffice',
    intgStep2Note:
      'Ассистент сам запускает командную строку hermesoffice; вводить её вам не придётся.',
    intgCliPartTitle: 'CLI · командная строка + skill',
    intgCliPartDesc:
      'Для ассистентов, умеющих выполнять команды терминала (Claude Code, Codex, Cursor и другие). После установки skill ассистент сам вызывает командную строку hermesoffice, чтобы создавать, конвертировать, читать и редактировать файлы; вам не нужно вводить команды.',
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP — общий протокол, через который ИИ-ассистенты вызывают внешние инструменты. Используйте его, если ассистент не умеет выполнять команды (например, Claude Desktop) или если хотите, чтобы он напрямую управлял окном HermesOffice. Выберите один из двух способов ниже.',
    intgMcpStdioTitle: 'Запускает ассистент (рекомендуется)',
    intgMcpStdioDesc:
      'Ассистент сам запускает hermesoffice mcp: здесь ничего включать не нужно, и HermesOffice не обязан быть открыт. Те же возможности, что у CLI.',
    intgMcpHttpTitle: 'Локальный HTTP-сервер',
    intgMcpHttpDesc:
      'Работает внутри HermesOffice; ассистент подключается по URL, и вы видите, как документ шаг за шагом собирается в редакторе Word. HermesOffice должен оставаться открытым; пока только документы Word.',
    intgMcpHttpAdvanced: 'Дополнительно: другие адреса и журнал',
    intgMcpTryNote: 'Ассистент обращается к HermesOffice через MCP; вам не нужно вводить команды.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCliTitle: 'Дополнительно: командная строка hermesoffice',
    intgCliReady: 'hermesoffice {v} · доступен в терминале ({path})',
    intgCliNotOnPath:
      'hermesoffice {v} · отсутствует в PATH терминала. Ассистенты всё равно находят его через ~/.hermesoffice/launcher, так что скилл работает. Чтобы вводить hermesoffice самостоятельно, выполните один раз:',
    ...
    intgCliEphemeral:
      'Сначала перетащите HermesOffice в «Программы», затем используйте командную строку.',
    intgCopyPath: 'Копировать путь',
    intgCliNeedsUpdate: 'Этому скиллу нужна командная строка {v} или новее; обновите HermesOffice.',
    ...
    setAiHermesHint: 'Использует вход в Hermes; ключ API не нужен.',
    ...
    setAiByokNote:
      'Чаты используют ваш собственный ключ. Генерация изображений и анализ медиа настраиваются в разделе «Медиа ИИ»; веб-поиск по-прежнему использует вход в Hermes или бесплатные источники.',
    setAiSave: 'Сохранить',
    ...
    setAiMediaHermesHint:
      'Генерация изображений и анализ изображений/видео используют ваш вход в Hermes.',
    setAiImageModel: 'Модель изображений',
    setAiAnalysisModel: 'Модель анализа',
    setAiSearchHermesHint:
      'Веб-поиск и поиск изображений используют ваш вход в Hermes; без входа или при выключенных облачных инструментах используются бесплатные источники.',
    ...
    setAiGskTools: 'Облачные инструменты Hermes',
    setAiGskToolsDesc:
      'Когда провайдером выбран Hermes, веб-поиск, генерация изображений и анализ медиа идут через Hermes и расходуют кредиты; при выключении поиск использует бесплатные источники, а инструменты изображений Hermes недоступны.',
    setGithub: 'Открытый код',
    starOnGitHub: 'Поставить звезду на GitHub',
    starPromptTitle: 'Нравится HermesOffice?',
    starPromptTitleN: 'Вы уже открыли {n} документов в HermesOffice',
    starPromptBody:
      'HermesOffice — бесплатное ПО с открытым кодом. Звезда на GitHub — лучшая поддержка для команды.',
    starPromptGo: 'Поставить звезду',
    starPromptDone: 'Уже поставлена',
    starPromptLater: 'Позже',
    onbStarHint: 'Если вам нравится HermesOffice, поставьте нам звезду на GitHub.',
    setEmail: 'Эл. почта',
    ...
    onbBody2:
      'HermesOffice пока в альфа-версии. Присоединяйтесь к групповому чату в GitHub, чтобы делиться отзывами и влиять на дальнейшее развитие.',
    onbCredits: 'Активные участники получают **1000+ кредитов Hermes**',
    onbJoinGitHub: 'Присоединиться к GitHub',
    onbSkip: 'Пропустить',
    onbNext: 'Далее',
    onbStart: 'Начать',
  ...
  ar: {
    ...
    navCloud: 'Hermes Projects',
    cloudSubtitle:
      'مشاريع أُنشئت على الويب باستخدام Hermes AI. يستمر التحرير في المتصفح — انقر على أي مشروع لفتحه.',
    ...
    cloudRefresh: 'تحديث',
    cloudLoginHint: 'سجّل الدخول إلى حساب Hermes لعرض المشاريع التي أنشأتها على الويب.',
    ...
    loginNetworkError: 'تعذّر الاتصال بـ Hermes — تحقق من الشبكة أو إعدادات الوكيل',
    ...
    intgHeroTitle: 'استخدم HermesOffice من مساعد الذكاء الاصطناعي',
    intgHeroDesc:
    ...
    intgStep1Update: 'عندما يجلب تحديث HermesOffice مهارة أحدث، يظهر زر «تحديث» بجوار ذلك المساعد.',
    ...
    intgOtherFolderDesc: 'اختر مجلد skills الخاص به وسيكتب HermesOffice الملف هناك.',
    ...
    intgExample3: 'حوّل budget.xlsx إلى PDF وافتحه في HermesOffice',
    intgStep2Note: 'المساعد يشغّل سطر أوامر hermesoffice بنفسه؛ لن تحتاج إلى كتابته أبداً.',
    intgCliPartTitle: 'CLI · سطر الأوامر + skill',
    intgCliPartDesc:
      'للمساعدين الذين يستطيعون تنفيذ أوامر الطرفية (Claude Code وCodex وCursor وغيرها). بعد تثبيت skill، يستدعي المساعد سطر أوامر hermesoffice بنفسه لإنشاء الملفات وتحويلها وقراءتها وتحريرها؛ لن تكتب أي أمر.',
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP هو البروتوكول المشترك الذي يستخدمه مساعدو الذكاء الاصطناعي لاستدعاء أدوات خارجية. استخدمه إذا كان مساعدك لا يستطيع تنفيذ الأوامر (مثل Claude Desktop) أو إذا أردت أن يتحكم في نافذة HermesOffice مباشرة. اختر إحدى الطريقتين أدناه.',
    intgMcpStdioTitle: 'يشغّله المساعد (موصى به)',
    intgMcpStdioDesc:
      'يشغّل المساعد hermesoffice mcp بنفسه: لا شيء لتفعيله هنا، ولا يلزم أن يكون HermesOffice مفتوحًا. نفس إمكانات CLI.',
    intgMcpHttpTitle: 'خادم HTTP محلي',
    intgMcpHttpDesc:
      'يعمل داخل HermesOffice؛ يتصل المساعد عبر عنوان URL ويمكنك مشاهدة المستند يُبنى خطوة بخطوة في محرر Word. يجب أن يبقى HermesOffice مفتوحًا؛ مستندات Word فقط حاليًا.',
    intgMcpHttpAdvanced: 'متقدم: عناوين أخرى والسجل',
    intgMcpTryNote: 'يستدعي المساعد HermesOffice عبر MCP؛ لن تكتب أي أمر.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCliTitle: 'متقدم: سطر أوامر hermesoffice',
    intgCliReady: 'hermesoffice {v} · جاهز في الطرفية ({path})',
    intgCliNotOnPath:
      'hermesoffice {v} · غير موجود في PATH الطرفية. ما زال المساعدون يجدونه عبر ~/.hermesoffice/launcher، فالمهارة تعمل. لكتابة hermesoffice بنفسك، شغّل هذا مرة واحدة:',
    ...
    intgCopied: 'تم النسخ',
    intgCliEphemeral: 'اسحب HermesOffice إلى مجلد التطبيقات أولاً، ثم استخدم سطر الأوامر.',
    intgCopyPath: 'نسخ المسار',
    intgCliNeedsUpdate: 'تحتاج هذه المهارة إلى سطر الأوامر {v} أو أحدث؛ حدّث HermesOffice.',
    ...
    setAiHermesHint: 'يستخدم تسجيل الدخول إلى Hermes؛ لا حاجة لمفتاح API.',
    ...
    setAiByokNote:
      'تستخدم المحادثات مفتاحك الخاص. يتبع توليد الصور وتحليل الوسائط قسم «وسائط الذكاء الاصطناعي»؛ ولا يزال البحث في الويب يستخدم تسجيل دخول Hermes أو مصادر مجانية.',
    setAiSave: 'حفظ',
    setAiSaved: 'تم الحفظ',
    ...
    setAiMediaHermesHint: 'يستخدم توليد الصور وتحليل الصور/الفيديو تسجيل دخولك إلى Hermes.',
    setAiImageModel: 'نموذج الصور',
    setAiAnalysisModel: 'نموذج التحليل',
    setAiSearchHermesHint:
      'يستخدم البحث في الويب والصور تسجيل دخولك إلى Hermes؛ وعند الخروج أو إيقاف الأدوات السحابية يعود إلى مصادر مجانية.',
    ...
    setAiGskTools: 'أدوات Hermes السحابية',
    setAiGskToolsDesc:
      'عندما يكون المزوّد Hermes، يمر البحث في الويب وتوليد الصور وتحليل الوسائط عبر Hermes ويستهلك الرصيد؛ عند الإيقاف يستخدم البحث مصادر مجانية وتصبح أدوات صور Hermes غير متاحة.',
    setGithub: 'مفتوح المصدر',
    starOnGitHub: 'ضع نجمة على GitHub',
    starPromptTitle: 'هل أعجبك HermesOffice؟',
    starPromptTitleN: 'لقد فتحت {n} من المستندات في HermesOffice',
    starPromptBody: 'HermesOffice مجاني ومفتوح المصدر. نجمة على GitHub هي أفضل دعم للفريق.',
    starPromptGo: 'ضع نجمة',
    starPromptDone: 'وضعتها بالفعل',
    starPromptLater: 'لاحقًا',
    onbStarHint: 'إذا أعجبك HermesOffice، ضع لنا نجمة على GitHub.',
    ...
    onbBody2:
      'لا يزال HermesOffice في مرحلة ألفا. انضم إلى الدردشة الجماعية على GitHub لمشاركة ملاحظاتك والمساهمة في تشكيل المستقبل.',
    onbCredits: 'يحصل المساهمون النشطون على **+1,000 من أرصدة Hermes**',
    onbJoinGitHub: 'الانضمام إلى GitHub',
    onbSkip: 'تخطي',
    onbNext: 'التالي',
    onbStart: 'ابدأ الآن',
  ...
  pt: {
    ...
    navCloud: 'Hermes Projects',
    cloudSubtitle:
      'Projetos criados na web com o Hermes AI. A edição continua no navegador — clique em um projeto para abri-lo.',
    ...
    cloudLoginHint: 'Entre na sua conta Hermes para ver os projetos criados na web.',
    ...
    loginCopied: 'Copiado',
    loginNetworkError:
      'Não foi possível conectar ao Hermes — verifique sua rede ou as configurações de proxy',
    ...
    intgHeroTitle: 'Use o HermesOffice a partir do seu assistente de IA',
    intgHeroDesc:
    ...
    intgStep1Update:
      'Quando uma atualização do HermesOffice trouxer um skill mais novo, um botão Atualizar aparece ao lado desse assistente.',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'Escolha a pasta de skills dele e o HermesOffice grava o arquivo lá.',
    ...
    intgExample3: 'Converta budget.xlsx para PDF e abra no HermesOffice',
    intgStep2Note:
      'O assistente executa a linha de comando hermesoffice sozinho; você nunca precisa digitá-la.',
    intgCliPartTitle: 'CLI · linha de comando + skill',
    intgCliPartDesc:
      'Para assistentes que executam comandos de terminal (Claude Code, Codex, Cursor e outros). Com o skill instalado, o assistente chama a linha de comando hermesoffice sozinho para criar, converter, ler e editar arquivos; você nunca digita um comando.',
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP é o protocolo comum que assistentes de IA usam para chamar ferramentas externas. Use-o quando o assistente não puder executar comandos (Claude Desktop, por exemplo) ou quando quiser que ele controle a janela do HermesOffice diretamente. Escolha uma das duas formas abaixo.',
    intgMcpStdioTitle: 'Iniciado pelo assistente (recomendado)',
    intgMcpStdioDesc:
      'O assistente inicia o hermesoffice mcp sozinho: nada para ligar aqui, e o HermesOffice não precisa estar aberto. Mesmos recursos da CLI.',
    intgMcpHttpTitle: 'Servidor HTTP local',
    intgMcpHttpDesc:
      'Roda dentro do HermesOffice; o assistente conecta por URL e você acompanha o documento sendo montado passo a passo no editor Word. O HermesOffice precisa ficar aberto; por enquanto só documentos Word.',
    intgMcpHttpAdvanced: 'Avançado: outros endereços e log',
    intgMcpTryNote: 'O assistente chama o HermesOffice via MCP; você nunca digita um comando.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCliTitle: 'Avançado: linha de comando hermesoffice',
    intgCliReady: 'hermesoffice {v} · pronto no seu terminal ({path})',
    intgCliNotOnPath:
      'hermesoffice {v} · não está no PATH do seu terminal. Os assistentes ainda o encontram por ~/.hermesoffice/launcher, então o skill funciona. Para digitar hermesoffice você mesmo, execute isto uma vez:',
    ...
    intgCopied: 'Copiado',
    intgCliEphemeral:
      'Arraste o HermesOffice para Aplicativos primeiro e depois use a linha de comando.',
    intgCopyPath: 'Copiar caminho',
    intgCliNeedsUpdate:
      'Este skill precisa da linha de comando {v} ou mais recente; atualize o HermesOffice.',
    ...
    setAiHermesHint: 'Usa seu login Hermes; nenhuma chave de API necessária.',
    ...
    setAiByokNote:
      'Os chats usam a sua própria chave. A geração de imagens e a análise de mídia seguem a seção «Mídia de IA»; a busca na web continua usando o login do Hermes ou fontes gratuitas.',
    setAiSave: 'Salvar',
    setAiSaved: 'Salvo',
    ...
    setAiMediaHermesHint:
      'A geração de imagens e a análise de imagens/vídeos usam o seu login do Hermes.',
    setAiImageModel: 'Modelo de imagem',
    setAiAnalysisModel: 'Modelo de análise',
    setAiSearchHermesHint:
      'A busca na web e de imagens usa o seu login do Hermes; desconectado ou com as ferramentas na nuvem desativadas, recorre a fontes gratuitas.',
    ...
    setAiGskTools: 'Ferramentas na nuvem Hermes',
    setAiGskToolsDesc:
      'Quando o provedor é o Hermes, a busca na web, a geração de imagens e a análise de mídia passam pelo Hermes e consomem créditos; desativado, a busca usa fontes gratuitas e as ferramentas de imagem do Hermes ficam indisponíveis.',
    setGithub: 'Código aberto',
    starOnGitHub: 'Dar uma estrela no GitHub',
    starPromptTitle: 'Gostando do HermesOffice?',
    starPromptTitleN: 'Você já abriu {n} documentos com o HermesOffice',
    starPromptBody:
      'O HermesOffice é gratuito e de código aberto. Uma estrela no GitHub é a melhor forma de apoiar a equipe.',
    starPromptGo: 'Dar uma estrela',
    starPromptDone: 'Já dei',
    starPromptLater: 'Mais tarde',
    onbStarHint: 'Se você gosta do HermesOffice, deixe uma estrela no GitHub.',
    setEmail: 'E-mail',
    ...
    onbBody2:
      'O HermesOffice ainda está em alfa. Entre no chat em grupo no GitHub para compartilhar feedback e ajudar a moldar o que vem a seguir.',
    onbCredits: 'Contribuidores ativos recebem **1.000+ créditos Hermes**',
    onbJoinGitHub: 'Entrar no GitHub',
    onbSkip: 'Pular',
    onbNext: 'Avançar',
    onbStart: 'Começar',
    onbStepAria: 'Página {n} de {total}',
  ...
  it: {
    ...
    navCloud: 'Hermes Projects',
    cloudSubtitle:
      'Progetti creati sul web con Hermes AI. La modifica continua nel browser: fai clic su un progetto per aprirlo.',
    ...
    cloudLoginHint: 'Accedi al tuo account Hermes per vedere i progetti creati sul web.',
    ...
    loginCopied: 'Copiato',
    loginNetworkError:
      'Impossibile raggiungere Hermes — controlla la rete o le impostazioni del proxy',
    ...
    intgHeroTitle: 'Usa HermesOffice dal tuo assistente IA',
    intgHeroDesc:
    ...
    intgStep1Update:
      "Quando un aggiornamento di HermesOffice porta uno skill più recente, accanto a quell'assistente compare un pulsante Aggiorna.",
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'Scegli la sua cartella skills e HermesOffice vi scrive il file.',
    ...
    intgExample3: 'Converti budget.xlsx in PDF e aprilo in HermesOffice',
    intgStep2Note:
      "L'assistente esegue da solo la riga di comando hermesoffice; non dovrai mai digitarla.",
    intgCliPartTitle: 'CLI · riga di comando + skill',
    intgCliPartDesc:
      'Per assistenti che possono eseguire comandi da terminale (Claude Code, Codex, Cursor e altri). Installato lo skill, l’assistente richiama da sé la riga di comando hermesoffice per creare, convertire, leggere e modificare file; non digiti mai un comando.',
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP è il protocollo comune con cui gli assistenti IA richiamano strumenti esterni. Usalo quando l’assistente non può eseguire comandi (Claude Desktop, ad esempio) o quando vuoi che controlli direttamente la finestra di HermesOffice. Scegli uno dei due modi qui sotto.',
    intgMcpStdioTitle: 'Avviato dall’assistente (consigliato)',
    intgMcpStdioDesc:
      'L’assistente avvia hermesoffice mcp da sé: niente da attivare qui, e HermesOffice non deve essere aperto. Stesse funzioni della CLI.',
    intgMcpHttpTitle: 'Server HTTP locale',
    intgMcpHttpDesc:
      'Gira dentro HermesOffice; l’assistente si collega a un URL e puoi vedere il documento prendere forma passo dopo passo nell’editor Word. HermesOffice deve restare aperto; per ora solo documenti Word.',
    intgMcpHttpAdvanced: 'Avanzato: altri indirizzi e registro',
    intgMcpTryNote: 'L’assistente richiama HermesOffice tramite MCP; non digiti mai un comando.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCliTitle: 'Avanzato: riga di comando hermesoffice',
    intgCliReady: 'hermesoffice {v} · pronto nel terminale ({path})',
    intgCliNotOnPath:
      'hermesoffice {v} · non è nel PATH del terminale. Gli assistenti lo trovano comunque tramite ~/.hermesoffice/launcher, quindi lo skill funziona. Per digitare hermesoffice tu stesso, esegui questo una volta:',
    ...
    intgCopied: 'Copiato',
    intgCliEphemeral: 'Trascina prima HermesOffice in Applicazioni, poi usa la riga di comando.',
    intgCopyPath: 'Copia percorso',
    intgCliNeedsUpdate:
      'Questo skill richiede la riga di comando {v} o successiva; aggiorna HermesOffice.',
    ...
    setAiHermesHint: 'Usa il tuo accesso Hermes; nessuna chiave API richiesta.',
    ...
    setAiByokNote:
      "Le chat usano la tua chiave. La generazione di immagini e l'analisi dei media seguono la sezione «Media IA»; la ricerca web usa ancora l'accesso Hermes o fonti gratuite.",
    setAiSave: 'Salva',
    setAiSaved: 'Salvato',
    ...
    setAiMediaHermesHint:
      "La generazione di immagini e l'analisi di immagini/video usano il tuo accesso Hermes.",
    setAiImageModel: 'Modello immagini',
    setAiAnalysisModel: 'Modello di analisi',
    setAiSearchHermesHint:
      'La ricerca web e di immagini usa il tuo accesso Hermes; disconnesso o con gli strumenti cloud disattivati ricorre a fonti gratuite.',
    ...
    setAiGskTools: 'Strumenti cloud Hermes',
    setAiGskToolsDesc:
      "Quando il provider è Hermes, la ricerca web, la generazione di immagini e l'analisi dei media passano da Hermes e consumano crediti; se disattivato, la ricerca usa fonti gratuite e gli strumenti immagine di Hermes non sono disponibili.",
    setGithub: 'Open source',
    starOnGitHub: 'Metti una stella su GitHub',
    starPromptTitle: 'Ti piace HermesOffice?',
    starPromptTitleN: 'Hai aperto {n} documenti con HermesOffice',
    starPromptBody:
      'HermesOffice è gratuito e open source. Una stella su GitHub è il modo migliore per sostenere il team.',
    starPromptGo: 'Metti una stella',
    starPromptDone: 'Già fatto',
    starPromptLater: 'Più tardi',
    onbStarHint: 'Se ti piace HermesOffice, lasciaci una stella su GitHub.',
    setEmail: 'Email',
    ...
    onbBody2:
      'HermesOffice è ancora in alpha. Unisciti alla chat di gruppo su GitHub per condividere feedback e contribuire a plasmare il futuro.',
    onbCredits: 'I collaboratori attivi ricevono **1.000+ crediti Hermes**',
    onbJoinGitHub: 'Unisciti a GitHub',
    onbSkip: 'Salta',
    onbNext: 'Avanti',
    onbStart: 'Inizia',
  ...
  pl: {
    ...
    navCloud: 'Hermes Projects',
    cloudSubtitle:
      'Projekty utworzone w sieci za pomocą Hermes AI. Edycja jest kontynuowana w przeglądarce — kliknij projekt, aby go otworzyć.',
    ...
    cloudLoginHint: 'Zaloguj się na konto Hermes, aby zobaczyć projekty utworzone w sieci.',
    ...
    loginNetworkError: 'Nie można połączyć się z Hermes — sprawdź sieć lub ustawienia proxy',
    ...
    intgHeroTitle: 'Używaj HermesOffice ze swojego asystenta AI',
    intgHeroDesc:
    ...
    intgStep1Update:
      'Gdy aktualizacja HermesOffice przyniesie nowszy skill, obok tego asystenta pojawi się przycisk Aktualizuj.',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'Wybierz jego folder skills, a HermesOffice zapisze tam plik.',
    ...
    intgExample3: 'Przekonwertuj budget.xlsx do PDF i otwórz w HermesOffice',
    intgStep2Note: 'Asystent sam uruchamia wiersz poleceń hermesoffice; nigdy nie musisz go wpisywać.',
    intgCliPartTitle: 'CLI · wiersz poleceń + skill',
    intgCliPartDesc:
      'Dla asystentów, które potrafią uruchamiać polecenia terminala (Claude Code, Codex, Cursor i inne). Po zainstalowaniu skilla asystent sam wywołuje wiersz poleceń hermesoffice, aby tworzyć, konwertować, czytać i edytować pliki; nigdy nie wpisujesz polecenia.',
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP to wspólny protokół, którym asystenci AI wywołują zewnętrzne narzędzia. Użyj go, gdy asystent nie potrafi uruchamiać poleceń (np. Claude Desktop) lub gdy chcesz, aby bezpośrednio sterował oknem HermesOffice. Wybierz jeden z dwóch sposobów poniżej.',
    intgMcpStdioTitle: 'Uruchamiany przez asystenta (zalecane)',
    intgMcpStdioDesc:
      'Asystent sam uruchamia hermesoffice mcp: nic tu nie trzeba włączać, a HermesOffice nie musi być otwarty. Te same funkcje co CLI.',
    intgMcpHttpTitle: 'Lokalny serwer HTTP',
    intgMcpHttpDesc:
      'Działa wewnątrz HermesOffice; asystent łączy się przez URL, a Ty widzisz, jak dokument powstaje krok po kroku w edytorze Word. HermesOffice musi pozostać otwarty; na razie tylko dokumenty Word.',
    intgMcpHttpAdvanced: 'Zaawansowane: inne adresy i dziennik',
    intgMcpTryNote: 'Asystent wywołuje HermesOffice przez MCP; nigdy nie wpisujesz polecenia.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCliTitle: 'Zaawansowane: wiersz poleceń hermesoffice',
    intgCliReady: 'hermesoffice {v} · gotowy w terminalu ({path})',
    intgCliNotOnPath:
      'hermesoffice {v} · nie ma go w PATH terminala. Asystenty i tak znajdą go przez ~/.hermesoffice/launcher, więc skill działa. Aby samodzielnie wpisywać hermesoffice, uruchom to raz:',
    ...
    intgCliEphemeral: 'Najpierw przenieś HermesOffice do Aplikacji, potem użyj wiersza poleceń.',
    intgCopyPath: 'Kopiuj ścieżkę',
    intgCliNeedsUpdate: 'Ten skill wymaga wiersza poleceń {v} lub nowszego; zaktualizuj HermesOffice.',
    ...
    setAiHermesHint: 'Korzysta z logowania Hermes; klucz API nie jest potrzebny.',
    ...
    setAiByokNote:
      'Czaty używają Twojego klucza. Generowanie obrazów i analiza mediów zależą od sekcji „Media AI”; wyszukiwanie w sieci nadal korzysta z logowania Hermes lub darmowych źródeł.',
    setAiSave: 'Zapisz',
    setAiSaved: 'Zapisano',
    ...
    setAiMediaHermesHint:
      'Generowanie obrazów i analiza obrazów/wideo korzystają z logowania Hermes.',
    setAiImageModel: 'Model obrazów',
    setAiAnalysisModel: 'Model analizy',
    setAiSearchHermesHint:
      'Wyszukiwanie w sieci i obrazów korzysta z logowania Hermes; po wylogowaniu lub przy wyłączonych narzędziach chmurowych używa darmowych źródeł.',
    ...
    setAiGskTools: 'Narzędzia chmurowe Hermes',
    setAiGskToolsDesc:
      'Gdy dostawcą jest Hermes, wyszukiwanie w sieci, generowanie obrazów i analiza mediów przechodzą przez Hermes i zużywają kredyty; po wyłączeniu wyszukiwanie używa darmowych źródeł, a narzędzia obrazów Hermes są niedostępne.',
    setGithub: 'Open source',
    starOnGitHub: 'Gwiazdka na GitHubie',
    starPromptTitle: 'Podoba Ci się HermesOffice?',
    starPromptTitleN: 'Otwarto już {n} dokumentów w HermesOffice',
    starPromptBody:
      'HermesOffice jest darmowy i open source. Gwiazdka na GitHubie to najlepsze wsparcie dla zespołu.',
    starPromptGo: 'Daj gwiazdkę',
    starPromptDone: 'Już zrobione',
    starPromptLater: 'Później',
    onbStarHint: 'Jeśli podoba Ci się HermesOffice, zostaw nam gwiazdkę na GitHubie.',
    setEmail: 'E-mail',
    ...
    onbBody2:
      'HermesOffice jest wciąż w fazie alfa. Dołącz do czatu grupowego na GitHub, aby dzielić się opiniami i współtworzyć jego przyszłość.',
    onbCredits: 'Aktywni współtwórcy otrzymują **1000+ kredytów Hermes**',
    onbJoinGitHub: 'Dołącz do GitHub',
    onbSkip: 'Pomiń',
    onbNext: 'Dalej',
    onbStart: 'Rozpocznij',
  ...
  cs: {
    ...
    navCloud: 'Hermes Projects',
    cloudSubtitle:
      'Projekty vytvořené na webu pomocí Hermes AI. Úpravy pokračují v prohlížeči — klikněte na projekt a otevřete ho.',
    ...
    cloudLoginHint:
      'Přihlaste se ke svému účtu Hermes a zobrazte projekty, které jste vytvořili na webu.',
    ...
    untitled: 'Bez názvu',
    noContent: '(prázdné)',
    accountHermes: 'Účet Hermes',
    account: 'Účet',
    login: 'Přihlásit se',
    loginHermes: 'Přihlásit se přes Hermes',
    loggedIn: 'Přihlášeno',
    loggedInHermes: 'Přihlášeno ke Hermes',
    waitingLogin:
    ...
    loginNetworkError: 'Hermes není dostupný — zkontrolujte síť nebo nastavení proxy',
    ...
    intgHeroTitle: 'Používejte HermesOffice ze svého AI asistenta',
    intgHeroDesc:
    ...
    intgStep1Update:
      'Když aktualizace HermesOffice přinese novější skill, u daného asistenta se objeví tlačítko Aktualizovat.',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'Vyberte jeho složku skills a HermesOffice tam soubor zapíše.',
    ...
    intgExample3: 'Převeď budget.xlsx do PDF a otevři ho v HermesOffice',
    intgStep2Note: 'Asistent spouští příkazový řádek hermesoffice sám; nikdy ho nemusíte psát.',
    intgCliPartTitle: 'CLI · příkazový řádek + skill',
    intgCliPartDesc:
      'Pro asistenty, kteří umí spouštět příkazy terminálu (Claude Code, Codex, Cursor a další). Po instalaci skillu asistent sám volá příkazový řádek hermesoffice k vytváření, převodu, čtení a úpravám souborů; žádný příkaz nepíšete.',
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP je společný protokol, kterým AI asistenti volají externí nástroje. Použijte ho, když asistent neumí spouštět příkazy (např. Claude Desktop) nebo když chcete, aby přímo ovládal okno HermesOffice. Vyberte jeden ze dvou způsobů níže.',
    intgMcpStdioTitle: 'Spouští asistent (doporučeno)',
    intgMcpStdioDesc:
      'Asistent spustí hermesoffice mcp sám: tady není co zapínat a HermesOffice nemusí být otevřený. Stejné funkce jako CLI.',
    intgMcpHttpTitle: 'Místní HTTP server',
    intgMcpHttpDesc:
      'Běží uvnitř HermesOffice; asistent se připojí přes URL a v editoru Word sledujete, jak dokument krok za krokem vzniká. HermesOffice musí zůstat otevřený; zatím jen dokumenty Word.',
    intgMcpHttpAdvanced: 'Pokročilé: další adresy a protokol',
    intgMcpTryNote: 'Asistent volá HermesOffice přes MCP; žádný příkaz nepíšete.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCliTitle: 'Pokročilé: příkazový řádek hermesoffice',
    intgCliReady: 'hermesoffice {v} · připraven v terminálu ({path})',
    intgCliNotOnPath:
      'hermesoffice {v} · není v PATH terminálu. Asistenti ho i tak najdou přes ~/.hermesoffice/launcher, skill tedy funguje. Chcete-li hermesoffice psát sami, spusťte jednou:',
    ...
    intgCliEphemeral: 'Nejprve přetáhněte HermesOffice do Aplikací a poté použijte příkazový řádek.',
    intgCopyPath: 'Kopírovat cestu',
    intgCliNeedsUpdate:
      'Tento skill vyžaduje příkazový řádek {v} nebo novější; aktualizujte HermesOffice.',
    ...
    setAiHermesHint: 'Používá vaše přihlášení ke Hermes; klíč API není potřeba.',
    ...
    setAiByokNote:
      'Chaty používají váš vlastní klíč. Generování obrázků a analýza médií se řídí sekcí AI média; webové vyhledávání dál používá přihlášení ke Hermes nebo bezplatné zdroje.',
    setAiSave: 'Uložit',
    setAiSaved: 'Uloženo',
    ...
    setAiMediaHermesHint:
      'Generování obrázků a analýza obrázků/videí používají vaše přihlášení ke Hermes.',
    setAiImageModel: 'Model pro obrázky',
    setAiAnalysisModel: 'Model pro analýzu',
    setAiSearchHermesHint:
      'Webové a obrázkové vyhledávání používá vaše přihlášení ke Hermes; při odhlášení nebo vypnutých cloudových nástrojích se použijí bezplatné zdroje.',
    ...
    setAiGskTools: 'Cloudové nástroje Hermes',
    setAiGskToolsDesc:
      'Webové vyhledávání, generování obrázků a analýza médií běží přes Hermes a čerpají kredity, pokud je jejich poskytovatel nastaven na Hermes; při vypnutí vyhledávání používá bezplatné zdroje a obrázkové nástroje Hermes nejsou dostupné.',
    setGithub: 'Open source',
    starOnGitHub: 'Dát hvězdičku na GitHubu',
    starPromptTitle: 'Líbí se vám HermesOffice?',
    starPromptTitleN: 'V HermesOffice jste otevřeli už {n} dokumentů',
    starPromptBody:
      'HermesOffice je zdarma a open source. Hvězdička na GitHubu je nejlepší způsob, jak tým podpořit.',
    starPromptGo: 'Dát hvězdičku na GitHubu',
    starPromptDone: 'Hvězdička už udělena',
    starPromptLater: 'Možná později',
    onbStarHint: 'Pokud se vám HermesOffice líbí, dejte nám hvězdičku na GitHubu.',
    setEmail: 'E-mail',
    ...
    newTab: 'Nová karta',
    // First-run onboarding
    onbTitle1: 'Vítejte v HermesOffice',
    ...
    onbBody2:
      'HermesOffice je stále ve fázi alfa. Připojte se ke skupinovému chatu na GitHub, sdílejte zpětnou vazbu a pomozte utvářet, co přijde dál.',
    onbCredits: 'Aktivní přispěvatelé získají **1 000+ kreditů Hermes**',
    onbJoinGitHub: 'Připojit se ke GitHub',
    onbSkip: 'Přeskočit',
    onbNext: 'Další',
    onbStart: 'Začít',
    ...
    onbNote3: 'Funkce AI mohou čerpat kredity Hermes.',
    onbBack: 'Zpět',
  ...
  nl: {
    ...
    navCloud: 'Hermes Projects',
    cloudSubtitle:
      'Projecten gemaakt op het web met Hermes AI. Bewerken gaat verder in je browser — klik op een project om het te openen.',
    ...
    cloudLoginHint:
      'Log in op je Hermes-account om projecten te zien die je op het web hebt gemaakt.',
    ...
    loginNetworkError: 'Kan Hermes niet bereiken — controleer uw netwerk of proxyinstellingen',
    ...
    intgHeroTitle: 'HermesOffice gebruiken vanuit uw AI-assistent',
    intgHeroDesc:
    ...
    intgStep1Update:
      'Wanneer een HermesOffice-update een nieuwere skill meebrengt, verschijnt naast die assistent een knop Bijwerken.',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'Kies zijn skills-map en HermesOffice schrijft het bestand daar.',
    ...
    intgExample3: 'Zet budget.xlsx om naar PDF en open het in HermesOffice',
    intgStep2Note:
      'De assistent voert de hermesoffice-opdrachtregel zelf uit; u hoeft die nooit te typen.',
    intgCliPartTitle: 'CLI · opdrachtregel + skill',
    intgCliPartDesc:
      'Voor assistenten die terminalopdrachten kunnen uitvoeren (Claude Code, Codex, Cursor en andere). Na installatie van de skill roept de assistent zelf de hermesoffice-opdrachtregel aan om bestanden te maken, converteren, lezen en bewerken; je typt nooit een opdracht.',
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP is het gemeenschappelijke protocol waarmee AI-assistenten externe tools aanroepen. Gebruik het als je assistent geen opdrachten kan uitvoeren (bijvoorbeeld Claude Desktop) of als je wilt dat hij het HermesOffice-venster rechtstreeks bestuurt. Kies een van de twee manieren hieronder.',
    intgMcpStdioTitle: 'Gestart door de assistent (aanbevolen)',
    intgMcpStdioDesc:
      'De assistent start hermesoffice mcp zelf: hier hoeft niets aan, en HermesOffice hoeft niet open te staan. Dezelfde functies als de CLI.',
    intgMcpHttpTitle: 'Lokale HTTP-server',
    intgMcpHttpDesc:
      'Draait in HermesOffice; de assistent verbindt via een URL en je ziet het document stap voor stap ontstaan in de Word-editor. HermesOffice moet open blijven; voorlopig alleen Word-documenten.',
    intgMcpHttpAdvanced: 'Geavanceerd: andere adressen en logboek',
    intgMcpTryNote: 'De assistent roept HermesOffice aan via MCP; je typt nooit een opdracht.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCliTitle: 'Geavanceerd: hermesoffice-opdrachtregel',
    intgCliReady: 'hermesoffice {v} · klaar in uw terminal ({path})',
    intgCliNotOnPath:
      'hermesoffice {v} · staat niet in het PATH van uw terminal. Assistenten vinden het toch via ~/.hermesoffice/launcher, dus de skill werkt. Om zelf hermesoffice te typen, voert u dit één keer uit:',
    ...
    intgCliEphemeral: "Sleep HermesOffice eerst naar Programma's en gebruik daarna de opdrachtregel.",
    intgCopyPath: 'Pad kopiëren',
    intgCliNeedsUpdate: 'Deze skill vereist opdrachtregel {v} of nieuwer; werk HermesOffice bij.',
    ...
    setAiHermesHint: 'Gebruikt je Hermes-login; geen API-sleutel nodig.',
    ...
    setAiByokNote:
      'Chats gebruiken je eigen sleutel. Afbeeldingen genereren en media-analyse volgen de sectie "AI-media"; zoeken op het web gebruikt nog steeds de Hermes-aanmelding of gratis bronnen.',
    setAiSave: 'Opslaan',
    ...
    setAiMediaHermesHint:
      'Afbeeldingen genereren en afbeelding-/video-analyse gebruiken je Hermes-aanmelding.',
    setAiImageModel: 'Afbeeldingsmodel',
    setAiAnalysisModel: 'Analysemodel',
    setAiSearchHermesHint:
      'Web- en afbeeldingszoeken gebruiken je Hermes-aanmelding; afgemeld of met cloudtools uit vallen ze terug op gratis bronnen.',
    ...
    setAiGskTools: 'Hermes-cloudtools',
    setAiGskToolsDesc:
      'Staat de provider op Hermes, dan lopen zoeken op het web, afbeeldingen genereren en media-analyse via Hermes en kosten ze credits; uitgeschakeld gebruikt zoeken gratis bronnen en zijn de Hermes-afbeeldingstools niet beschikbaar.',
    setGithub: 'Open source',
    starOnGitHub: 'Geef een ster op GitHub',
    starPromptTitle: 'Bevalt HermesOffice?',
    starPromptTitleN: 'Je hebt al {n} documenten geopend met HermesOffice',
    starPromptBody:
      'HermesOffice is gratis en open source. Een ster op GitHub is de beste steun voor het team.',
    starPromptGo: 'Geef een ster',
    starPromptDone: 'Al gedaan',
    starPromptLater: 'Later',
    onbStarHint: 'Als HermesOffice je bevalt, geef ons dan een ster op GitHub.',
    setEmail: 'E-mail',
    ...
    onbBody2:
      'HermesOffice is nog in alfa. Doe mee aan de groepschat op GitHub om feedback te delen en mee te bepalen wat er komt.',
    onbCredits: 'Actieve bijdragers krijgen **1.000+ Hermes-credits**',
    onbJoinGitHub: 'Word lid van GitHub',
    onbSkip: 'Overslaan',
    onbNext: 'Volgende',
  ...
  ms: {
    ...
    navCloud: 'Hermes Projects',
    cloudSubtitle:
      'Projek yang dicipta di web dengan Hermes AI. Penyuntingan diteruskan dalam pelayar — klik projek untuk membukanya.',
    ...
    cloudLoginHint: 'Log masuk ke akaun Hermes untuk melihat projek yang anda cipta di web.',
    ...
    loginCopied: 'Disalin',
    loginNetworkError:
      'Tidak dapat menyambung ke Hermes — semak rangkaian atau tetapan proksi anda',
    ...
    setSecAbout: 'Perihal',
    setSecIntegrations: 'Integrasi',
    intgHeroTitle: 'Gunakan HermesOffice daripada pembantu AI anda',
    intgHeroDesc:
    ...
    intgStep1Update:
      'Apabila kemas kini HermesOffice membawa skill yang lebih baharu, butang Kemas kini muncul di sebelah pembantu itu.',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'Pilih folder skills pembantu itu dan HermesOffice menulis fail di sana.',
    ...
    intgExample3: 'Tukar budget.xlsx kepada PDF dan buka dalam HermesOffice',
    intgStep2Note:
      'Pembantu menjalankan baris arahan hermesoffice sendiri; anda tidak perlu menaipnya.',
    intgCliPartTitle: 'CLI · baris arahan + skill',
    intgCliPartDesc:
      'Untuk pembantu yang boleh menjalankan arahan terminal (Claude Code, Codex, Cursor dan lain-lain). Setelah skill dipasang, pembantu memanggil baris arahan hermesoffice sendiri untuk mencipta, menukar, membaca dan mengedit fail; anda tidak perlu menaip sebarang arahan.',
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP ialah protokol umum yang digunakan pembantu AI untuk memanggil alat luaran. Gunakannya apabila pembantu anda tidak boleh menjalankan arahan (contohnya Claude Desktop) atau apabila anda mahu ia mengawal tetingkap HermesOffice secara langsung. Pilih salah satu daripada dua cara di bawah.',
    intgMcpStdioTitle: 'Dimulakan oleh pembantu (disyorkan)',
    intgMcpStdioDesc:
      'Pembantu melancarkan hermesoffice mcp sendiri: tiada apa yang perlu dihidupkan di sini, dan HermesOffice tidak perlu dibuka. Ciri sama seperti CLI.',
    intgMcpHttpTitle: 'Pelayan HTTP tempatan',
    intgMcpHttpDesc:
      'Berjalan di dalam HermesOffice; pembantu menyambung melalui URL dan anda boleh melihat dokumen dibina langkah demi langkah dalam editor Word. HermesOffice mesti kekal dibuka; buat masa ini dokumen Word sahaja.',
    intgMcpHttpAdvanced: 'Lanjutan: alamat lain dan log',
    intgMcpTryNote:
      'Pembantu memanggil HermesOffice melalui MCP; anda tidak perlu menaip sebarang arahan.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCliTitle: 'Lanjutan: baris arahan hermesoffice',
    intgCliReady: 'hermesoffice {v} · sedia dalam terminal anda ({path})',
    intgCliNotOnPath:
      'hermesoffice {v} · tiada dalam PATH terminal anda. Pembantu masih menemuinya melalui ~/.hermesoffice/launcher, jadi skill berfungsi. Untuk menaip hermesoffice sendiri, jalankan ini sekali:',
    ...
    intgSavedTo: 'Disimpan ke {path}',
    intgCopied: 'Disalin',
    intgCliEphemeral: 'Seret HermesOffice ke Applications dahulu, kemudian gunakan baris arahan.',
    intgCopyPath: 'Salin laluan',
    intgCliNeedsUpdate:
      'Skill ini memerlukan baris arahan {v} atau lebih baharu; kemas kini HermesOffice.',
    ...
    setAiHermesHint: 'Menggunakan log masuk Hermes; tiada kunci API diperlukan.',
    ...
    setAiByokNote:
      'Sembang menggunakan kunci anda sendiri. Penjanaan imej dan analisis media mengikut bahagian "Media AI"; carian web masih menggunakan log masuk Hermes atau sumber percuma.',
    setAiSave: 'Simpan',
    setAiSaved: 'Disimpan',
    ...
    setAiMediaHermesHint:
      'Penjanaan imej dan analisis imej/video menggunakan log masuk Hermes anda.',
    setAiImageModel: 'Model imej',
    setAiAnalysisModel: 'Model analisis',
    setAiSearchHermesHint:
      'Carian web dan imej menggunakan log masuk Hermes anda; apabila log keluar atau alat awan dimatikan, ia menggunakan sumber percuma.',
    ...
    setAiGskTools: 'Alat awan Hermes',
    setAiGskToolsDesc:
      'Apabila pembekalnya ditetapkan kepada Hermes, carian web, penjanaan imej dan analisis media melalui Hermes dan menggunakan kredit; apabila dimatikan, carian menggunakan sumber percuma dan alat imej Hermes tidak tersedia.',
    setGithub: 'Sumber Terbuka',
    starOnGitHub: 'Beri Bintang di GitHub',
    starPromptTitle: 'Suka HermesOffice?',
    starPromptTitleN: 'Anda telah membuka {n} dokumen dengan HermesOffice',
    starPromptBody:
      'HermesOffice percuma dan sumber terbuka. Bintang di GitHub ialah sokongan terbaik untuk pasukan kami.',
    starPromptGo: 'Beri Bintang',
    starPromptDone: 'Sudah',
    starPromptLater: 'Kemudian',
    onbStarHint: 'Jika anda suka HermesOffice, beri kami bintang di GitHub.',
    setEmail: 'E-mel',
    ...
    onbTitle2: 'Ini baru permulaan',
    onbBody2:
      'HermesOffice masih dalam peringkat alfa. Sertai sembang kumpulan di GitHub untuk berkongsi maklum balas dan membentuk masa depannya.',
    onbCredits: 'Penyumbang aktif menerima **1,000+ kredit Hermes**',
    onbJoinGitHub: 'Sertai GitHub',
    onbSkip: 'Langkau',
    onbNext: 'Seterusnya',
    onbStart: 'Mula',
  ...
  he: {
    ...
    navCloud: 'Hermes Projects',
    cloudSubtitle:
      'פרויקטים שנוצרו באינטרנט עם Hermes AI. העריכה נמשכת בדפדפן — לחצו על פרויקט כדי לפתוח אותו.',
    ...
    cloudRefresh: 'רענון',
    cloudLoginHint: 'התחברו לחשבון Hermes כדי לראות פרויקטים שיצרתם באתר.',
    ...
    loginCopied: 'הועתק',
    loginNetworkError: 'לא ניתן להתחבר ל-Hermes — בדקו את הרשת או את הגדרות ה-proxy',
    ...
    intgHeroTitle: 'שימוש ב-HermesOffice מתוך עוזר ה-AI שלכם',
    intgHeroDesc:
    ...
    intgStep1Update: 'כשעדכון של HermesOffice מביא skill חדש יותר, ליד אותו עוזר יופיע כפתור עדכון.',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'בחרו את תיקיית ה-skills שלו ו-HermesOffice יכתוב שם את הקובץ.',
    ...
    intgExample3: 'המר את budget.xlsx ל-PDF ופתח אותו ב-HermesOffice',
    intgStep2Note: 'העוזר מריץ בעצמו את שורת הפקודה hermesoffice; לעולם לא תצטרכו להקליד אותה.',
    intgCliPartTitle: 'CLI · שורת פקודה + skill',
    intgCliPartDesc:
      'לעוזרים שיכולים להריץ פקודות טרמינל (Claude Code‏, Codex‏, Cursor ואחרים). לאחר התקנת ה‑skill העוזר קורא בעצמו לשורת הפקודה hermesoffice כדי ליצור, להמיר, לקרוא ולערוך קבצים; אתם לא מקלידים שום פקודה.',
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP הוא הפרוטוקול המשותף שבו עוזרי AI קוראים לכלים חיצוניים. השתמשו בו כשהעוזר אינו יכול להריץ פקודות (למשל Claude Desktop) או כשאתם רוצים שהוא ישלוט ישירות בחלון HermesOffice. בחרו אחת משתי הדרכים למטה.',
    intgMcpStdioTitle: 'מופעל על ידי העוזר (מומלץ)',
    intgMcpStdioDesc:
      'העוזר מפעיל את hermesoffice mcp בעצמו: אין מה להפעיל כאן, ו‑HermesOffice לא חייב להיות פתוח. אותן יכולות כמו ב‑CLI.',
    intgMcpHttpTitle: 'שרת HTTP מקומי',
    intgMcpHttpDesc:
      'פועל בתוך HermesOffice; העוזר מתחבר דרך כתובת URL ואפשר לראות את המסמך נבנה צעד אחר צעד בעורך Word. HermesOffice חייב להישאר פתוח; בשלב זה מסמכי Word בלבד.',
    intgMcpHttpAdvanced: 'מתקדם: כתובות נוספות ויומן',
    intgMcpTryNote: 'העוזר קורא ל‑HermesOffice דרך MCP; אתם לא מקלידים שום פקודה.',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCliTitle: 'מתקדם: שורת הפקודה hermesoffice',
    intgCliReady: 'hermesoffice {v} · מוכן בטרמינל ({path})',
    intgCliNotOnPath:
      'hermesoffice {v} · לא נמצא ב-PATH של הטרמינל. העוזרים עדיין מוצאים אותו דרך ~/.hermesoffice/launcher, ולכן ה-skill עובד. כדי להקליד hermesoffice בעצמכם, הריצו זאת פעם אחת:',
    ...
    intgCopied: 'הועתק',
    intgCliEphemeral: 'גררו קודם את HermesOffice לתיקיית היישומים, ואז השתמשו בשורת הפקודה.',
    intgCopyPath: 'העתקת נתיב',
    intgCliNeedsUpdate: 'skill זה דורש שורת פקודה {v} ומעלה; עדכנו את HermesOffice.',
    intgLoading: 'בודק…',
    ...
    setAiHermesHint: 'משתמש בכניסת Hermes שלך; אין צורך במפתח API.',
    ...
    setAiByokNote:
      'הצ׳אטים משתמשים במפתח שלך. יצירת תמונות וניתוח מדיה נקבעים בקטע "מדיה AI"; חיפוש באינטרנט עדיין משתמש בהתחברות Hermes או במקורות חינמיים.',
    setAiSave: 'שמירה',
    setAiSaved: 'נשמר',
    ...
    setAiMediaHermesHint: 'יצירת תמונות וניתוח תמונות/וידאו משתמשים בהתחברות Hermes שלך.',
    setAiImageModel: 'מודל תמונות',
    setAiAnalysisModel: 'מודל ניתוח',
    setAiSearchHermesHint:
      'חיפוש באינטרנט ובתמונות משתמש בהתחברות Hermes שלך; כשלא מחוברים או כשכלי הענן כבויים הוא חוזר למקורות חינמיים.',
    ...
    setAiGskTools: 'כלי הענן של Hermes',
    setAiGskToolsDesc:
      'כשהספק מוגדר ל-Hermes, חיפוש באינטרנט, יצירת תמונות וניתוח מדיה עוברים דרך Hermes וצורכים קרדיטים; כשהוא כבוי החיפוש משתמש במקורות חינמיים וכלי התמונות של Hermes אינם זמינים.',
    setGithub: 'קוד פתוח',
    starOnGitHub: 'תנו כוכב ב-GitHub',
    starPromptTitle: 'נהנים מ-HermesOffice?',
    starPromptTitleN: 'פתחת {n} מסמכים עם HermesOffice',
    starPromptBody: 'HermesOffice חינמי ובקוד פתוח. כוכב ב-GitHub הוא התמיכה הטובה ביותר בצוות.',
    starPromptGo: 'לתת כוכב',
    starPromptDone: 'כבר נתתי',
    starPromptLater: 'אחר כך',
    onbStarHint: 'אם HermesOffice מוצא חן בעיניכם, תנו לנו כוכב ב-GitHub.',
    setEmail: 'אימייל',
    ...
    onbBody2:
      'HermesOffice עדיין בגרסת אלפא. הצטרפו לצ׳אט הקבוצתי ב-GitHub כדי לשתף משוב ולעזור לעצב את ההמשך.',
    onbCredits: 'תורמים פעילים מקבלים **1,000+ נקודות Hermes**',
    onbJoinGitHub: 'הצטרפו ל-GitHub',
    onbSkip: 'דילוג',
    onbNext: 'הבא',
    onbStart: 'להתחיל',
  ...
  hi: {
    ...
    navCloud: 'Hermes Projects',
    cloudSubtitle:
      'Hermes AI के साथ वेब पर बनाए गए प्रोजेक्ट। संपादन ब्राउज़र में जारी रहता है — खोलने के लिए किसी प्रोजेक्ट पर क्लिक करें।',
    ...
    cloudLoginHint: 'वेब पर बनाए गए प्रोजेक्ट देखने के लिए अपने Hermes खाते में साइन इन करें।',
    ...
    loginNetworkError: 'Hermes से कनेक्ट नहीं हो सका — नेटवर्क या प्रॉक्सी सेटिंग जांचें',
    ...
    intgHeroTitle: 'अपने AI असिस्टेंट से HermesOffice इस्तेमाल करें',
    intgHeroDesc:
    ...
    intgStep1Update:
      'जब HermesOffice के अपडेट में नया skill आता है, तो उस असिस्टेंट के पास अपडेट बटन दिखता है।',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'उसका skills फ़ोल्डर चुनें, HermesOffice वहाँ फ़ाइल लिख देगा।',
    ...
    intgExample3: 'budget.xlsx को PDF में बदलो और HermesOffice में खोलो',
    intgStep2Note: 'hermesoffice कमांड लाइन असिस्टेंट खुद चलाता है; आपको कभी टाइप नहीं करना पड़ता।',
    intgCliPartTitle: 'CLI · कमांड लाइन + skill',
    intgCliPartDesc:
      'उन सहायकों के लिए जो टर्मिनल कमांड चला सकते हैं (Claude Code, Codex, Cursor आदि)। skill इंस्टॉल होने के बाद सहायक फ़ाइलें बनाने, बदलने, पढ़ने और संपादित करने के लिए खुद hermesoffice कमांड लाइन चलाता है; आपको कोई कमांड टाइप नहीं करना पड़ता।',
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP वह साझा प्रोटोकॉल है जिससे AI सहायक बाहरी टूल बुलाते हैं। इसे तब चुनें जब सहायक कमांड न चला सके (जैसे Claude Desktop) या आप चाहें कि वह HermesOffice की विंडो को सीधे चलाए। नीचे दिए दो तरीकों में से कोई एक चुनें।',
    intgMcpStdioTitle: 'सहायक द्वारा शुरू (अनुशंसित)',
    intgMcpStdioDesc:
      'सहायक खुद hermesoffice mcp चलाता है: यहाँ कुछ चालू करने की ज़रूरत नहीं, और HermesOffice खुला होना भी ज़रूरी नहीं। सुविधाएँ CLI जैसी ही।',
    intgMcpHttpTitle: 'स्थानीय HTTP सर्वर',
    intgMcpHttpDesc:
      'HermesOffice के अंदर चलता है; सहायक URL से जुड़ता है और आप Word संपादक में दस्तावेज़ को चरण-दर-चरण बनते देख सकते हैं। HermesOffice खुला रहना चाहिए; अभी केवल Word दस्तावेज़।',
    intgMcpHttpAdvanced: 'उन्नत: अन्य पते और लॉग',
    intgMcpTryNote:
      'सहायक MCP के ज़रिये HermesOffice को बुलाता है; आपको कोई कमांड टाइप नहीं करना पड़ता।',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCliTitle: 'उन्नत: hermesoffice कमांड लाइन',
    intgCliReady: 'hermesoffice {v} · टर्मिनल में तैयार ({path})',
    intgCliNotOnPath:
      'hermesoffice {v} · टर्मिनल के PATH में नहीं है। असिस्टेंट इसे ~/.hermesoffice/launcher से फिर भी ढूँढ लेते हैं, इसलिए skill काम करता है। खुद hermesoffice टाइप करने के लिए यह एक बार चलाएँ:',
    ...
    intgCliEphemeral: 'पहले HermesOffice को Applications में खींचें, फिर कमांड लाइन का उपयोग करें।',
    intgCopyPath: 'पथ कॉपी करें',
    intgCliNeedsUpdate: 'इस skill को कमांड लाइन {v} या नया चाहिए; HermesOffice अपडेट करें।',
    ...
    setAiHermesHint: 'आपके Hermes साइन-इन का उपयोग करता है; API कुंजी की आवश्यकता नहीं।',
    ...
    setAiByokNote:
      'चैट आपकी अपनी कुंजी का उपयोग करती हैं। इमेज जनरेशन और मीडिया विश्लेषण "AI मीडिया" अनुभाग के अनुसार होते हैं; वेब खोज अभी भी Hermes साइन-इन या मुफ़्त स्रोतों का उपयोग करती है।',
    setAiSave: 'सहेजें',
    ...
    setAiMediaHermesHint:
      'इमेज जनरेशन और इमेज/वीडियो विश्लेषण आपके Hermes साइन-इन का उपयोग करते हैं।',
    setAiImageModel: 'इमेज मॉडल',
    setAiAnalysisModel: 'विश्लेषण मॉडल',
    setAiSearchHermesHint:
      'वेब और इमेज खोज आपके Hermes साइन-इन का उपयोग करती हैं; साइन-आउट होने पर या क्लाउड टूल बंद होने पर वे मुफ़्त स्रोतों पर लौट जाती हैं।',
    ...
    setAiGskTools: 'Hermes क्लाउड टूल',
    setAiGskToolsDesc:
      'जब प्रदाता Hermes हो, वेब खोज, इमेज जनरेशन और मीडिया विश्लेषण Hermes से होकर चलते हैं और क्रेडिट खर्च करते हैं; बंद होने पर खोज मुफ़्त स्रोत उपयोग करती है और Hermes इमेज टूल उपलब्ध नहीं रहते।',
    setGithub: 'ओपन सोर्स',
    starOnGitHub: 'GitHub पर स्टार दें',
    starPromptTitle: 'HermesOffice पसंद आ रहा है?',
    starPromptTitleN: 'आपने HermesOffice में {n} दस्तावेज़ खोले हैं',
    starPromptBody:
      'HermesOffice मुफ़्त और ओपन सोर्स है। GitHub पर एक स्टार टीम का सबसे अच्छा समर्थन है।',
    starPromptGo: 'स्टार दें',
    starPromptDone: 'पहले ही दे दिया',
    starPromptLater: 'बाद में',
    onbStarHint: 'अगर आपको HermesOffice पसंद है, तो हमें GitHub पर स्टार दें।',
    setEmail: 'ईमेल',
    ...
    onbBody2:
      'HermesOffice अभी अल्फ़ा में है। GitHub पर ग्रुप चैट से जुड़ें, फ़ीडबैक साझा करें और आगे की दिशा तय करने में मदद करें।',
    onbCredits: 'सक्रिय योगदानकर्ताओं के लिए **1,000+ Hermes क्रेडिट**',
    onbJoinGitHub: 'GitHub से जुड़ें',
    onbSkip: 'छोड़ें',
    onbNext: 'आगे',
    onbStart: 'शुरू करें',
  ...
  'zh-TW': {
    ...
    navStarred: '收藏',
    navCloud: 'Hermes Projects',
    cloudSubtitle: '在網頁端用 Hermes AI 建立的專案。編輯在瀏覽器中繼續——點擊任意專案即可開啟。',
    ...
    cloudSortOldest: '最早',
    cloudRefresh: '重新整理',
    cloudLoginHint: '登入 Hermes 帳號，查看你在網頁端建立的專案。',
    cloudEmpty: '還沒有網頁端專案。',
    ...
    loginCopyUrl: '複製登入連結',
    loginCopied: '已複製',
    loginNetworkError: '無法連線至 Hermes，請檢查網路或代理設定',
    ...
    intgHeroTitle: '在 AI 助理中使用 HermesOffice',
    intgHeroDesc:
    ...
    intgStep1Update: 'HermesOffice 升級帶來新版 skill 時，對應助理旁會出現「更新」按鈕。',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: '選擇它的 skills 資料夾，HermesOffice 會把檔案寫進去。',
    ...
    intgExample3: '把 budget.xlsx 轉成 PDF，並在 HermesOffice 中開啟',
    intgStep2Note: '助理會自行呼叫 hermesoffice 命令列，你不需要輸入任何指令。',
    intgCliPartTitle: 'CLI · 命令列 + skill',
    intgCliPartDesc:
      '適合能執行終端機指令的助理（Claude Code、Codex、Cursor 等）。安裝 skill 後，助理會自己呼叫 hermesoffice 命令列建立、轉換、讀取和編輯檔案，你不需要輸入任何指令。',
    intgMcpPartTitle: 'MCP',
    intgMcpPartDesc:
      'MCP 是 AI 助理呼叫外部工具的通用協定。助理不能執行指令（如 Claude Desktop），或你想讓它直接操作 HermesOffice 視窗時用這條路。下面兩種接法任選一種。',
    intgMcpStdioTitle: '由助理啟動（建議）',
    intgMcpStdioDesc:
      '助理自己啟動 hermesoffice mcp，不需要在這裡開任何開關，HermesOffice 也不用開著。功能與 CLI 完全相同。',
    intgMcpHttpTitle: '本機 HTTP 服務',
    intgMcpHttpDesc:
      '在 HermesOffice 內執行，助理透過網址連線，可以看著它在 Word 編輯器裡逐步產生。需要 HermesOffice 保持開啟；目前只支援 Word。',
    intgMcpHttpAdvanced: '進階：其他位址與記錄',
    intgMcpTryNote: '助理會透過 MCP 呼叫 HermesOffice，你不需要輸入任何指令。',
    intgMcpClaudeTitle: 'Claude Code',
    ...
    intgCliTitle: '進階：命令列 hermesoffice',
    intgCliReady: 'hermesoffice {v} · 已可在終端機直接使用（{path}）',
    intgCliNotOnPath:
      'hermesoffice {v} · 尚未加入終端機 PATH。助理仍能透過 ~/.hermesoffice/launcher 找到它，skill 不受影響。若想自己在終端機輸入 hermesoffice，執行一次：',
    ...
    intgCopied: '已複製',
    intgCliEphemeral: '請先把 HermesOffice 拖到「應用程式」，再使用命令列。',
    intgCopyPath: '複製路徑',
    intgCliNeedsUpdate: '此 skill 需要命令列 {v} 或更新版本，請更新 HermesOffice。',
    intgLoading: '正在檢查…',
    intgUpdateDue: 'skill 有新版本可更新',
    setSecAiModel: 'AI 模型',
    setAiProvider: '模型服務商',
    ...
    setAiHermesHint: '使用 Hermes 帳號登入，無需 API key。',
    ...
    setAiByokNote:
      '對話使用你自己的 key；生圖與媒體解析依「生圖與媒體」設定；網頁搜尋仍走 Hermes 登入或免費來源。',
    setAiSave: '儲存',
    setAiSaved: '已儲存',
    setAiTest: '測試連線',
    setAiTesting: '測試中…',
    ...
    setAiMediaHermesHint: '生圖與圖片/影片解析使用 Hermes 帳號登入。',
    setAiImageModel: '生圖模型',
    setAiAnalysisModel: '解析模型',
    setAiSearchHermesHint:
      '網頁與圖片搜尋使用 Hermes 帳號登入；未登入或關閉雲端工具時改用免費來源。',
    ...
    setAiGskTools: 'Hermes 雲端工具',
    setAiGskToolsDesc:
      '服務商選擇 Hermes 時，網頁搜尋、生圖與媒體解析經 Hermes 雲端並消耗點數；關閉後搜尋改用免費來源，Hermes 生圖工具不可用。',
    setGithub: '開源專案',
    starOnGitHub: '到 GitHub 給我們一顆星',
    starPromptTitle: '喜歡 HermesOffice 嗎？',
    starPromptTitleN: '你已經用 HermesOffice 開啟了 {n} 個文件',
    starPromptBody: 'HermesOffice 是免費的開源軟體。到 GitHub 給我們一顆星，是對團隊最好的支持。',
    starPromptGo: '去給星星',
    starPromptDone: '已經給過了',
    starPromptLater: '以後再說',
    onbStarHint: '如果你喜歡 HermesOffice，歡迎到 GitHub 給我們一顆星。',
    setEmail: '電子郵件',
    setNotLoggedIn: '未登入',
    setViewUsage: '查看用量',
    setChange: '變更',
    ...
    onbTitle2: '這只是一個開始',
    onbBody2: 'HermesOffice 目前仍在 alpha 階段。歡迎加入 GitHub 群聊，分享回饋，一起打造它的未來。',

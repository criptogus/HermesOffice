...
export const strings = {
  zh: {
    ...
    noContent: '（无内容）',
    // Account
    accountGenspark: 'Hermes 账号',
    account: '账号',
    login: '登录',
    loginGenspark: '配置 Hermes',
    loggedIn: '已登录',
    loggedInGenspark: '已连接 Hermes',
    ...
    setAiGensparkHint: '使用 Hermes（本地网关），无需 API key。',
    setAiByokNote: '对话使用你自己的 API key。',
    setAiSave: '保存',
    setAiSaved: '已保存',
    setAiTest: '测试连接',
    setAiTesting: '测试中…',
    ...
    onbTitle2: '这只是一个开始',
    onbBody2: 'HermesOffice 是开源软件。欢迎到 GitHub 上贡献代码，一起完善它的下一个版本。',
  ...
  en: {
    ...
    untitled: 'Untitled',
    noContent: '(empty)',
    accountGenspark: 'Hermes Account',
    account: 'Account',
    login: 'Sign in',
    loginGenspark: 'Set up Hermes',
    loggedIn: 'Signed in',
    loggedInGenspark: 'Connected to Hermes',
    ...
    setAiGensparkHint: 'Uses your local Hermes; no API key needed.',
    setAiByokNote: 'Chats use your own API key.',
    setAiSave: 'Save',
    setAiSaved: 'Saved',
    ...
    onbBody2: 'HermesOffice is open source. Contribute on GitHub and help shape what comes next.',
    ...
    onbNote3: 'AI runs on the local Hermes gateway.',
    onbBack: 'Back',
  },
  ja: {
    // Sidebar navigation
    ...
    noContent: '（内容なし）',
    // Account
    accountGenspark: 'Hermes アカウント',
    account: 'アカウント',
    login: 'サインイン',
    loginGenspark: 'Hermes を設定',
    loggedIn: 'サインイン済み',
    loggedInGenspark: 'Hermes に接続済み',
    waitingLogin:
    ...
    loginCopied: 'コピーしました',
    loginNetworkError: 'Hermes に接続できません。ネットワークまたはプロキシ設定を確認してください',
    ...
    setAiGensparkHint: 'ローカルの Hermes を使用するため、API キーは不要です。',
    setAiByokNote: 'チャットは自分の API キーを使用します。',
    setAiSave: '保存',
    setAiSaved: '保存しました',
    setAiTest: '接続テスト',
    setAiTesting: 'テスト中…',
    ...
    setAiGskToolsDesc:
      'ウェブ検索・AI 画像生成・メディア分析はクラウド経由で処理します。オフにすると画像ツールは使えず、検索は無料ソースを使用します。',
    setGithub: 'オープンソース',
    ...
    onbNote3: 'AI はローカル Hermes ゲートウェイを使用します。',
    onbBack: '戻る',
  },
  ko: {
    // Sidebar navigation
    ...
    noContent: '(내용 없음)',
    // Account
    accountGenspark: 'Hermes 계정',
    account: '계정',
    login: '로그인',
    loginGenspark: 'Hermes 설정',
    loggedIn: '로그인됨',
    loggedInGenspark: 'Hermes에 연결됨',
    ...
    setAiGensparkHint: '로컬 Hermes를 사용하며 API 키가 필요 없습니다.',
    setAiByokNote: '채팅은 자체 API 키를 사용합니다.',
    setAiSave: '저장',
    setAiSaved: '저장됨',
    setAiTest: '연결 테스트',
    setAiTesting: '테스트 중…',
    ...
    setAiGskToolsDesc:
      '웹 검색·AI 이미지 생성·미디어 분석은 클라우드를 거쳐 처리합니다. 끄면 이미지 도구를 사용할 수 없고 검색은 무료 소스를 사용합니다.',
    setGithub: '오픈 소스',
    ...
    onbNote3: 'AI는 로컬 Hermes 게이트웨이를 사용합니다.',
    onbBack: '이전',
  },
  fr: {
    // Sidebar navigation
    ...
    noContent: '(vide)',
    // Account
    accountGenspark: 'Compte Hermes',
    account: 'Compte',
    login: 'Se connecter',
    loginGenspark: 'Configurer Hermes',
    loggedIn: 'Connecté',
    loggedInGenspark: 'Connecté à Hermes',
    waitingLogin:
    ...
    setAiGensparkHint: 'Utilise votre Hermes local ; aucune clé API requise.',
    setAiByokNote: 'Les conversations utilisent votre propre clé.',
    ...
    setAiGskToolsDesc:
      "Recherche web, génération d'images et analyse de médias passent par le cloud ; désactivé, les outils d'image sont indisponibles et la recherche utilise des sources gratuites.",
    setGithub: 'Open source',
    ...
    onbBody2: 'HermesOffice est open source. Contribuez sur GitHub et aidez à façonner la suite.',
    ...
    onbNote3: "L'IA utilise la passerelle Hermes locale.",
    onbBack: 'Retour',
  },
  de: {
    // Sidebar navigation
    ...
    noContent: '(leer)',
    // Account
    accountGenspark: 'Hermes-Konto',
    account: 'Konto',
    login: 'Anmelden',
    loginGenspark: 'Hermes einrichten',
    loggedIn: 'Angemeldet',
    loggedInGenspark: 'Mit Hermes verbunden',
    waitingLogin:
    ...
    setAiGensparkHint: 'Nutzt Ihren lokalen Hermes; kein API-Schlüssel nötig.',
    setAiByokNote: 'Chats verwenden Ihren eigenen API-Schlüssel.',
    setAiSave: 'Speichern',
    ...
    setAiGskTools: 'Cloud-Tools',
    setAiGskToolsDesc:
      'Websuche, KI-Bilderzeugung und Medienanalyse laufen über die Cloud und verbrauchen Guthaben; ausgeschaltet sind Bildtools nicht verfügbar und die Suche nutzt freie Quellen.',
    setGithub: 'Open Source',
    ...
    onbNote3: 'KI läuft auf dem lokalen Hermes-Gateway.',
    onbBack: 'Zurück',
  },
  es: {
    // Sidebar navigation
    ...
    noContent: '(vacío)',
    // Account
    accountGenspark: 'Cuenta de Hermes',
    account: 'Cuenta',
    login: 'Iniciar sesión',
    loginGenspark: 'Configurar Hermes',
    loggedIn: 'Sesión iniciada',
    loggedInGenspark: 'Conectado a Hermes',
    waitingLogin:
    ...
    setAiGensparkHint: 'Usa tu Hermes local; no se necesita clave de API.',
    setAiByokNote: 'Los chats usan tu propia clave de API.',
    setAiSave: 'Guardar',
    setAiSaved: 'Guardado',
    ...
    setAiGskToolsDesc:
      'La búsqueda web, la generación de imágenes y el análisis de medios pasan por la nube y consumen créditos; desactivado, las herramientas de imagen no están disponibles y la búsqueda usa fuentes gratuitas.',
    ...
    onbNote3: 'La IA utiliza el gateway local de Hermes.',
    onbBack: 'Atrás',
  },
  th: {
    // Sidebar navigation
    ...
    // Account
    accountGenspark: 'บัญชี Hermes',
    account: 'บัญชี',
    login: 'ลงชื่อเข้าใช้',
    loginGenspark: 'ตั้งค่า Hermes',
    loggedIn: 'ลงชื่อเข้าใช้แล้ว',
    loggedInGenspark: 'เชื่อมต่อ Hermes แล้ว',
    ...
    setAiGensparkHint: 'ใช้ Hermes ในเครื่อง ไม่ต้องใช้คีย์ API',
    setAiByokNote: 'แชทใช้คีย์ API ของคุณเอง',
    setAiSave: 'บันทึก',
    ...
    setAiGskToolsDesc:
      'ค้นเว็บ สร้างภาพ AI และวิเคราะห์สื่อผ่านคลาวด์และใช้เครดิต ปิดแล้วเครื่องมือภาพจะใช้ไม่ได้ และการค้นหาใช้แหล่งฟรี',
    ...
    onbBody2: 'HermesOffice เป็นโอเพนซอร์ส ร่วมสนับสนุนบน GitHub และช่วยกำหนดทิศทางต่อไป',
    ...
    onbNote3: 'AI ใช้เกตเวย์ Hermes ในเครื่อง',
    onbBack: 'ย้อนกลับ',
  },
  id: {
    // Sidebar navigation
    ...
    noContent: '(kosong)',
    // Account
    accountGenspark: 'Akun Hermes',
    account: 'Akun',
    login: 'Masuk',
    loginGenspark: 'Konfigurasi Hermes',
    loggedIn: 'Sudah masuk',
    loggedInGenspark: 'Terhubung ke Hermes',
    ...
    setAiGensparkHint: 'Menggunakan Hermes lokal; tanpa kunci API.',
    setAiByokNote: 'Obrolan memakai kunci API Anda sendiri.',
    setAiSave: 'Simpan',
    ...
    setAiGskToolsDesc:
      'Pencarian web, pembuatan gambar AI, dan analisis media berjalan lewat cloud dan memakai kredit; jika dimatikan, alat gambar tidak tersedia dan pencarian memakai sumber gratis.',
    ...
    onbNote3: 'AI berjalan pada gateway Hermes lokal.',
    onbBack: 'Kembali',
  },
  ru: {
    // Sidebar navigation
    ...
    login: 'Войти',
    loginGenspark: 'Настроить Hermes',
    loggedIn: 'Вход выполнен',
    loggedInGenspark: 'Подключено к Hermes',
    ...
    setAiGensparkHint: 'Использует локальный Hermes; ключ API не нужен.',
    setAiByokNote: 'Чаты используют ваш собственный ключ API.',
    setAiSave: 'Сохранить',
    ...
    setAiGskToolsDesc:
      'Веб-поиск, генерация изображений и анализ медиа идут через облако и расходуют кредиты; при отключении инструменты изображений недоступны, а поиск использует бесплатные источники.',
    ...
    onbNote3: 'ИИ работает на локальном шлюзе Hermes.',
    onbBack: 'Назад',
  },
  ar: {
    // Sidebar navigation
    ...
    noContent: '(فارغ)',
    // Account
    accountGenspark: 'حساب Hermes',
    account: 'الحساب',
    login: 'تسجيل الدخول',
    loginGenspark: 'إعداد Hermes',
    loggedIn: 'تم تسجيل الدخول',
    loggedInGenspark: 'متصل بـ Hermes',
    ...
    setAiGensparkHint: 'يستخدم Hermes المحلي؛ لا حاجة لمفتاح API.',
    setAiByokNote: 'تستخدم المحادثات مفتاح API الخاص بك.',
    setAiSave: 'حفظ',
    setAiSaved: 'تم الحفظ',
    ...
    setAiGskTools: 'الأدوات السحابية',
    setAiGskToolsDesc:
      'يمر بحث الويب وتوليد الصور وتحليل الوسائط عبر السحابة ويستهلك الرصيد؛ عند الإيقاف تصبح أدوات الصور غير متاحة ويستخدم البحث مصادر مجانية.',
    ...
    onbBody2: 'HermesOffice برنامج مفتوح المصدر. ساهم عبر GitHub وساعد في تشكيل ما هو قادم.',
    ...
    onbNote3: 'يعمل الذكاء الاصطناعي على بوابة Hermes المحلية.',
    onbBack: 'رجوع',
  },
  pt: {
    navRecent: 'Recentes',
    ...
    untitled: 'Sem título',
    noContent: '(vazio)',
    accountGenspark: 'Conta Hermes',
    account: 'Conta',
    login: 'Entrar',
    loginGenspark: 'Configurar Hermes',
    loggedIn: 'Conectado',
    loggedInGenspark: 'Conectado ao Hermes',
    ...
    setAiGensparkHint: 'Usa seu Hermes local; nenhuma chave de API necessária.',
    setAiByokNote: 'Os chats usam sua própria chave de API.',
    setAiSave: 'Salvar',
    setAiSaved: 'Salvo',
    ...
    setAiGskToolsDesc:
      'Busca na web, geração de imagens e análise de mídia passam pela nuvem e consomem créditos; desligado, as ferramentas de imagem ficam indisponíveis e a busca usa fontes gratuitas.',
    ...
    onbNote3: 'A IA usa o gateway local do Hermes.',
    onbBack: 'Voltar',
  },
  it: {
    navRecent: 'Recenti',
    ...
    account: 'Account',
    login: 'Accedi',
    loginGenspark: 'Configura Hermes',
    loggedIn: 'Accesso effettuato',
    loggedInGenspark: 'Connesso a Hermes',
    ...
    setAiGensparkHint: 'Usa il tuo Hermes locale; nessuna chiave API richiesta.',
    setAiByokNote: 'Le chat usano la tua chiave API.',
    setAiSave: 'Salva',
    setAiSaved: 'Salvato',
    ...
    setAiGskToolsDesc:
      'Ricerca web, generazione di immagini e analisi dei media passano dal cloud e consumano crediti; se disattivato, gli strumenti immagine non sono disponibili e la ricerca usa fonti gratuite.',
    setGithub: 'Open source',
    ...
    onbNote3: "L'IA usa il gateway Hermes locale.",
    onbBack: 'Indietro',
  },
  pl: {
    navRecent: 'Ostatnie',
    ...
    untitled: 'Bez tytułu',
    noContent: '(pusto)',
    accountGenspark: 'Konto Hermes',
    account: 'Konto',
    login: 'Zaloguj się',
    loginGenspark: 'Skonfiguruj Hermes',
    loggedIn: 'Zalogowano',
    loggedInGenspark: 'Połączono z Hermes',
    waitingLogin:
    ...
    setAiGensparkHint: 'Korzysta z lokalnego Hermes; klucz API nie jest potrzebny.',
    setAiByokNote: 'Czaty używają Twojego klucza API.',
    setAiSave: 'Zapisz',
    setAiSaved: 'Zapisano',
    ...
    setAiGskToolsDesc:
      'Wyszukiwanie w sieci, generowanie obrazów AI i analiza mediów przechodzą przez chmurę i zużywają kredyty; po wyłączeniu narzędzia obrazów są niedostępne, a wyszukiwanie korzysta z darmowych źródeł.',
    setGithub: 'Open source',
    ...
    onbNote3: 'AI działa na lokalnym Hermes.',
    onbBack: 'Wstecz',
  },
  nl: {
    navRecent: 'Recent',
    ...
    account: 'Account',
    login: 'Inloggen',
    loginGenspark: 'Hermes instellen',
    loggedIn: 'Ingelogd',
    loggedInGenspark: 'Verbonden met Hermes',
    ...
    setAiGensparkHint: 'Gebruikt je lokale Hermes; geen API-sleutel nodig.',
    setAiByokNote: 'Chats gebruiken je eigen API-sleutel.',
    setAiSave: 'Opslaan',
    ...
    setAiGskTools: 'Cloud-tools',
    setAiGskToolsDesc:
      'Webzoeken, AI-beeldgeneratie en media-analyse lopen via de cloud en verbruiken tegoed; uitgeschakeld zijn beeldtools niet beschikbaar en gebruikt zoeken gratis bronnen.',
    setGithub: 'Open source',
    ...
    onbBody2: 'HermesOffice is open source. Draag bij op GitHub en help bepalen wat er komt.',
    ...
    onbNote3: 'AI draait op de lokale Hermes-gateway.',
    onbBack: 'Terug',
  },
  ms: {
    navRecent: 'Terkini',
    ...
    noContent: '(kosong)',
    accountGenspark: 'Akaun Hermes',
    account: 'Akaun',
    login: 'Log masuk',
    loginGenspark: 'Sediakan Hermes',
    loggedIn: 'Telah log masuk',
    loggedInGenspark: 'Disambung ke Hermes',
    ...
    setAiGensparkHint: 'Menggunakan Hermes setempat; tiada kunci API diperlukan.',
    setAiByokNote: 'Sembang menggunakan kunci API sendiri.',
    setAiSave: 'Simpan',
    setAiSaved: 'Disimpan',
    ...
    onbNote3: 'AI berjalan pada gerbang Hermes setempat.',
    onbBack: 'Kembali',
  },
  he: {
    navRecent: 'אחרונים',
    ...
    cloudSubtitle:
      'פרויקטי AI שנוצרו באינטרנט. העריכה נמשכת בדפדפן — לחצו על פרויקט כדי לפתוח אותו.',
    ...
    untitled: 'ללא שם',
    noContent: '(ריק)',
    accountGenspark: 'חשבון Hermes',
    account: 'חשבון',
    login: 'התחברות',
    loginGenspark: 'הגדר את Hermes',
    loggedIn: 'מחובר',
    loggedInGenspark: 'מחובר ל-Hermes',
    ...
    setAiGensparkHint: 'משתמש ב-Hermes המקומי; אין צורך במפתח API.',
    setAiByokNote: 'השיחות משתמשות במפתח ה-API שלך.',
    setAiSave: 'שמירה',
    setAiSaved: 'נשמר',
    ...
    setAiGskTools: 'כלי ענן',
    setAiGskToolsDesc:
      'חיפוש ברשת, יצירת תמונות וניתוח מדיה עוברים דרך הענן וצורכים קרדיטים; בכיבוי, כלי התמונות אינם זמינים והחיפוש משתמש במקורות חינמיים.',
    setGithub: 'קוד פתוח',
    ...
    onbBody2: 'HermesOffice הוא קוד פתוח. תרמו ב-GitHub ועזרו לעצב את ההמשך.',
    ...
    onbNote3: 'AI פועל על שער Hermes המקומי.',
    onbBack: 'חזרה',
  },
  hi: {
    navRecent: 'हाल के',
    ...
    noContent: '(खाली)',
    accountGenspark: 'Hermes खाता',
    account: 'खाता',
    login: 'साइन इन करें',
    loginGenspark: 'Hermes सेट करें',
    loggedIn: 'साइन इन हो गया',
    loggedInGenspark: 'Hermes से कनेक्ट',
    waitingLogin:
    ...
    setAiGensparkHint: 'आपके स्थानीय Hermes का उपयोग करता है; API कुंजी की आवश्यकता नहीं।',
    setAiByokNote: 'चैट आपकी अपनी API कुंजी का उपयोग करती हैं।',
    setAiSave: 'सहेजें',
    ...
    onbNote3: 'AI स्थानीय Hermes गेटवे पर चलता है।',
    onbBack: 'वापस',
  },
  'zh-TW': {
    navRecent: '最近',
    ...
    cloudSortOldest: '最早',
    cloudRefresh: '重新整理',
    cloudLoginHint: '登入後即可查看你在網頁端建立的專案。',
    cloudEmpty: '還沒有網頁端專案。',
    ...
    untitled: '未命名',
    noContent: '（無內容）',
    accountGenspark: 'Hermes 帳號',
    account: '帳號',
    login: '登入',
    loginGenspark: '設定 Hermes',
    loggedIn: '已登入',
    loggedInGenspark: '已連接 Hermes',
    ...
    setAiGensparkHint: '使用本機 Hermes，無需 API key。',
    setAiByokNote: '對話使用你自己的 API key。',
    setAiSave: '儲存',
    setAiSaved: '已儲存',
    setAiTest: '測試連線',
    setAiTesting: '測試中…',
    ...
    setAiGskTools: '雲端工具',
    setAiGskToolsDesc:
      '網頁搜尋、AI 生圖、媒體分析經雲端處理；關閉後生圖與媒體分析不可用，搜尋改用免費來源。',
    setGithub: '開源專案',
    ...
    onbTitle2: '這只是一個開始',
    onbBody2: 'HermesOffice 是開源軟體。歡迎到 GitHub 貢獻來攜手完善它的下一步。',

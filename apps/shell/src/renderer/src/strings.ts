...
export const strings = {
  zh: {
    ...
    newTab: '新建标签页',
    sendTo: '发送到…',
    cloudConnect: '连接 Google 云端硬盘',
    cloudConnecting: '连接中…',
    cloudConnected: '已连接',
    cloudDisconnect: '断开连接',
    cloudProvider: '提供商',
    cloudLastUpload: '上次上传',
    cloudDriveLabel: 'Google Drive',
    cloudSynced: '已同步',
    cloudSyncError: '同步出错',
    cloudConnectError: '无法连接 Google Drive，请重试。',
  ...
  en: {
    ...
    cloudLastUpload: 'Last upload',
    cloudDriveLabel: 'Google Drive',
    cloudSynced: 'Synced',
    cloudSyncError: 'Sync error',
    cloudConnectError: 'Could not connect Google Drive. Please try again.',
    // First-run onboarding
  ...
  ja: {
    ...
    newTab: '新しいタブ',
    sendTo: '送信…',
    cloudConnect: 'Google ドライブに接続',
    cloudConnecting: '接続中…',
    cloudConnected: '接続済み',
    cloudDisconnect: '切断',
    cloudProvider: 'プロバイダー',
    cloudLastUpload: '最後の送信',
    cloudDriveLabel: 'Google Drive',
    cloudSynced: '同期済み',
    cloudSyncError: '同期エラー',
    cloudConnectError: 'Google Drive に接続できませんでした。もう一度お試しください。',
    // First-run onboarding
  ...
  ko: {
    ...
    newTab: '새 탭',
    sendTo: '보내기…',
    cloudConnect: 'Google 드라이브 연결',
    cloudConnecting: '연결 중…',
    cloudConnected: '연결됨',
    cloudDisconnect: '연결 해제',
    cloudProvider: '공급자',
    cloudLastUpload: '마지막 업로드',
    cloudDriveLabel: 'Google Drive',
    cloudSynced: '동기화됨',
    cloudSyncError: '동기화 오류',
    cloudConnectError: 'Google Drive에 연결할 수 없습니다. 다시 시도해 주세요.',
    // First-run onboarding
  ...
  fr: {
    ...
    sendTo: 'Envoyer à…',
    cloudConnect: 'Connecter Google Drive',
    cloudConnecting: 'Connexion…',
    cloudConnected: 'Connecté',
    cloudDisconnect: 'Déconnecter',
    cloudProvider: 'Fournisseur',
    cloudLastUpload: 'Dernier envoi',
    cloudDriveLabel: 'Google Drive',
    cloudSynced: 'Synchronisé',
    cloudSyncError: 'Erreur de synchronisation',
    cloudConnectError: 'Impossible de connecter Google Drive. Réessayez.',
    // First-run onboarding
  ...
  de: {
    ...
    newTab: 'Neuer Tab',
    sendTo: 'Senden an…',
    cloudConnect: 'Google Drive verbinden',
    cloudConnecting: 'Verbinde…',
    cloudConnected: 'Verbunden',
    cloudDisconnect: 'Trennen',
    cloudProvider: 'Anbieter',
    cloudLastUpload: 'Letzter Upload',
    cloudDriveLabel: 'Google Drive',
    cloudSynced: 'Synchronisiert',
    cloudSyncError: 'Synchronisierungsfehler',
    cloudConnectError: 'Google Drive konnte nicht verbunden werden. Bitte erneut versuchen.',
    // First-run onboarding
  ...
  es: {
    ...
    cloudLastUpload: 'Último envío',
    cloudDriveLabel: 'Google Drive',
    cloudSynced: 'Sincronizado',
    cloudSyncError: 'Error de sincronización',
    cloudConnectError: 'No se pudo conectar Google Drive. Inténtalo de nuevo.',
    // First-run onboarding
  ...
  th: {
    ...
    cloudLastUpload: 'Último envío',
    cloudDriveLabel: 'Google Drive',
    cloudSynced: 'ซิงค์แล้ว',
    cloudSyncError: 'ข้อผิดพลาดในการซิงค์',
    cloudConnectError: 'ไม่สามารถเชื่อมต่อ Google Drive ได้ โปรดลองอีกครั้ง',
    // First-run onboarding
  ...
  id: {
    ...
    cloudConnected: 'Terhubung',
    cloudDisconnect: 'Putuskan',
    cloudProvider: 'Penyedia',
    cloudLastUpload: 'Unggahan terakhir',
    cloudDriveLabel: 'Google Drive',
    cloudSynced: 'Tersinkronisasi',
    cloudSyncError: 'Kesalahan sinkronisasi',
    cloudConnectError: 'Tidak dapat menghubungkan Google Drive. Coba lagi.',
    // First-run onboarding
  ...
  ar: {
    ...
    sendTo: 'إرسال إلى…',
    cloudConnect: 'ربط Google Drive',
    cloudConnecting: 'جارٍ الاتصال…',
    cloudConnected: 'متصل',
    cloudDisconnect: 'قطع الاتصال',
    cloudProvider: 'المزود',
    cloudLastUpload: 'آخر إرسال',
    cloudDriveLabel: 'Google Drive',
    cloudSynced: 'تمت المزامنة',
    cloudSyncError: 'خطأ في المزامنة',
    cloudConnectError: 'تعذّر الاتصال بـ Google Drive. حاول مرة أخرى.',
    // First-run onboarding
  ...
  pt: {
    ...
    cloudConnected: 'Conectado',
    cloudDisconnect: 'Desconectar',
    cloudProvider: 'Provedor',
    cloudLastUpload: 'Último envio',
    cloudDriveLabel: 'Google Drive',
    cloudSynced: 'Sincronizado',
    cloudSyncError: 'Erro na sincronização',
    cloudConnectError: 'Não foi possível conectar o Google Drive. Tente novamente.',
    // First-run onboarding
  ...
  it: {
    ...
    newTab: 'Nuova scheda',
    sendTo: 'Invia a…',
    cloudConnect: 'Connetti Google Drive',
    cloudConnecting: 'Connessione…',
    cloudConnected: 'Connesso',
    cloudDisconnect: 'Disconnetti',
    cloudProvider: 'Fornitore',
    cloudLastUpload: 'Ultimo invio',
    cloudDriveLabel: 'Google Drive',
    cloudSynced: 'Sincronizzato',
    cloudSyncError: 'Errore di sincronizzazione',
    cloudConnectError: 'Impossibile connettere Google Drive. Riprova.',
    // First-run onboarding
  ...
  pl: {
    ...
    newTab: 'Nowa karta',
    sendTo: 'Wyślij do…',
    cloudConnect: 'Połącz Google Drive',
    cloudConnecting: 'Łączenie…',
    cloudConnected: 'Połączono',
    cloudDisconnect: 'Rozłącz',
    cloudProvider: 'Dostawca',
    cloudLastUpload: 'Ostatnia wysyłka',
    cloudDriveLabel: 'Google Drive',
    cloudSynced: 'Zsynchronizowano',
    cloudSyncError: 'Błąd synchronizacji',
    cloudConnectError: 'Nie można połączyć się z Google Drive. Spróbuj ponownie.',
    // First-run onboarding
  ...
  nl: {
    ...
    cloudConnected: 'Verbonden',
    cloudDisconnect: 'Verbinding verbreken',
    cloudProvider: 'Provider',
    cloudLastUpload: 'Laatste upload',
    cloudDriveLabel: 'Google Drive',
    cloudSynced: 'Gesynchroniseerd',
    cloudSyncError: 'Synchronisatiefout',
    cloudConnectError: 'Kan geen verbinding maken met Google Drive. Probeer het opnieuw.',
    // First-run onboarding
  ...
  ms: {
    ...
    cloudLastUpload: 'Laatste upload',
    cloudDriveLabel: 'Google Drive',
    cloudSynced: 'Diselaraskan',
    cloudSyncError: 'Ralat penyegerakan',
    cloudConnectError: 'Tidak dapat menyambung Google Drive. Sila cuba lagi.',
    // First-run onboarding
  ...
  he: {
    ...
    cloudDriveLabel: 'Google Drive',
    cloudSynced: 'מסונכרן',
    cloudSyncError: 'שגיאת סנכרון',
    cloudConnectError: 'לא ניתן להתחבר ל-Google Drive. נסה שוב.',
    // First-run onboarding
  ...
  hi: {
    ...
    newTab: 'नया टैब',
    sendTo: 'भेजें…',
    cloudConnect: 'Google Drive कनेक्ट करें',
    cloudConnecting: 'कनेक्ट हो रहा है…',
    cloudConnected: 'कनेक्टेड',
    cloudDisconnect: 'डिस्कनेक्ट करें',
    cloudProvider: 'प्रदाता',
    cloudLastUpload: 'आखिरी अपलोड',
    cloudDriveLabel: 'Google Drive',
    cloudSynced: 'सिंक हो गया',
    cloudSyncError: 'सिंक त्रुटि',
    cloudConnectError: 'Google Drive से कनेक्ट नहीं हो सका। कृपया पुनः प्रयास करें।',
    // First-run onboarding
  ...
  'zh-TW': {
    ...
    cloudSynced: '已同步',
    cloudSyncError: '同步錯誤',
    cloudConnectError: '無法連線 Google Drive，請重試。',
    // First-run onboarding

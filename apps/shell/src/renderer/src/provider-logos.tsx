...
import type { AiProviderId } from '@hermesoffice/ai-provider'
...
const LOGOS: Record<AiProviderId, ReactNode> = {
  hermes: (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      <path d="M12 2 3.7 6.6v6.9c0 4.4 3.4 7.5 8.3 8.5 4.9-1 8.3-4.1 8.3-8.5V6.6L12 2z" />
      <path d="M8.4 16.5V7.5h2.1l3.6 5.6V7.5h2v9h-2.2l-3.5-5.5v5.5H8.4z" fill="var(--card)" />
    </svg>
  ),
  genspark: (

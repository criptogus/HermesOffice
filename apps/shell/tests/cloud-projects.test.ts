...
import { gskListPastProjects, type GskPastProjectsPage } from '@hermesoffice/ai-search'
import {
  cloudStoreOwner,
...
vi.mock('@hermesoffice/ai-search', async (importOriginal) => {
  const actual = await importOriginal<typeof import('@hermesoffice/ai-search')>()

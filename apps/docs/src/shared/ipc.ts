...
import type { HeadlessExportTarget } from '@hermesoffice/electron-utils/headless-export'
...
/** mirrors VIEW_IMAGE_CHANNEL in @hermesoffice/electron-utils (kept literal so the preload stays free of main-only deps) */

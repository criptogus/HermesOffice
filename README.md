...
**Is HermesOffice free?**
Yes. HermesOffice is free and open-source under the Apache-2.0 license — no
trial, no paid tier for the apps themselves.

**Can HermesOffice open Microsoft Word, Excel, and PowerPoint files?**
Yes. HermesOffice opens and saves native `.docx`, `.xlsx`, and `.pptx` files.
...
**Does HermesOffice work offline?**
...
**Can HermesOffice edit PDF files?**
...
Yes — HermesOffice converts PDFs into editable `.docx`, `.xlsx`, and `.pptx`
...
Yes. Besides the keyless Genspark sign-in, HermesOffice supports bring your own
...
**Does HermesOffice collect any data?**
...
See [HermesOffice Privacy](PRIVACY.md) for the complete event and data disclosures.
